	...
	<tbody>
		<?php 
			...
			if($keywords && $this->session->userdata('user_type') === 'Org Admin') {
				// January
			$jan_date = $year.'-01-';
			$jan_payment = get_month_wise_fees($jan_date, $item['org_id'],null,$keywords);
			
			// February
			$feb_date = $year.'-02-';
			$feb_payment = get_month_wise_fees($feb_date, $item['org_id'],null,$keywords);
			
			// March
			$mar_date = $year.'-03-';
			$mar_payment = get_month_wise_fees($mar_date, $item['org_id'],null,$keywords);
			
			// April
			$apr_date = $year.'-04-';
			$apr_payment = get_month_wise_fees($apr_date, $item['org_id'],null,$keywords);
			
			//May
			$may_date = $year.'-05-';
			$may_payment = get_month_wise_fees($may_date, $item['org_id'],null,$keywords);
			
			//June
			$jun_date = $year.'-06-';
			$jun_payment = get_month_wise_fees($jun_date, $item['org_id'],null,$keywords);
			
			//July
			$jul_date = $year.'-07-';
			$jul_payment = get_month_wise_fees($jul_date, $item['org_id'],null,$keywords);
			
			//August
			$aug_date = $year.'-08-';
			$aug_payment = get_month_wise_fees($aug_date, $item['org_id'],null,$keywords);
			
			//September
			$sep_date = $year.'-09-';
			$sep_payment = get_month_wise_fees($sep_date, $item['org_id'],null,$keywords);
			
			//October
			$oct_date = $year.'-10-';
			$oct_payment = get_month_wise_fees($oct_date, $item['org_id'],null,$keywords);
			
			//November
			$nov_date = $year.'-11-';
			$nov_payment = get_month_wise_fees($nov_date, $item['org_id'],null,$keywords);
			
			//December
			$dec_date = $year.'-12-';
			$dec_payment = get_month_wise_fees($dec_date, $item['org_id'],null,$keywords);
			}else{
			$jan_date = date("Y").'-01-';
			$jan_payment = get_month_wise_fees($jan_date, $item['org_id']);
			
			// February
			$feb_date = date("Y").'-02-';
			$feb_payment = get_month_wise_fees($feb_date, $item['org_id']);
			
			// March
			$mar_date = date("Y").'-03-';
			$mar_payment = get_month_wise_fees($mar_date, $item['org_id']);
			
			// April
			$apr_date = date("Y").'-04-';
			$apr_payment = get_month_wise_fees($apr_date, $item['org_id']);
			
			//May
			$may_date = date("Y").'-05-';
			$may_payment = get_month_wise_fees($may_date, $item['org_id']);
			
			//June
			$jun_date = date("Y").'-06-';
			$jun_payment = get_month_wise_fees($jun_date, $item['org_id']);
			
			//July
			$jul_date = date("Y").'-07-';
			$jul_payment = get_month_wise_fees($jul_date, $item['org_id']);
			
			//August
			$aug_date = date("Y").'-08-';
			$aug_payment = get_month_wise_fees($aug_date, $item['org_id']);
			
			//September
			$sep_date = date("Y").'-09-';
			$sep_payment = get_month_wise_fees($sep_date, $item['org_id']);
			
			//October
			$oct_date = date("Y").'-10-';
			$oct_payment = get_month_wise_fees($oct_date, $item['org_id']);
			
			//November
			$nov_date = date("Y").'-11-';
			$nov_payment = get_month_wise_fees($nov_date, $item['org_id']);
			
			//December
			$dec_date = date("Y").'-12-';
			$dec_payment = get_month_wise_fees($dec_date, $item['org_id']);
			}
