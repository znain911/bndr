	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default block2">
				<div class="panel-heading text-center">REGISTER DOCTOR</div>
				<div class="panel-wrapper collapse in put-relative" aria-expanded="true">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input type="text" name="bmdc_no" placeholder="BMDC No" class="form-control">
							</div>
						</div>
						<div class="form-group">
					...
					<div class="panel-footer text-right"> 
						<button class="btn btn-info waves-effect waves-light m-t-10" type="submit">Register Doctor</button> 
						<span onclick="window.location.href='<?php echo base_url('doctors'); ?>'" class="btn btn-danger waves-effect waves-light m-t-10">Cancel</span>
					</div>
					<?php echo form_close(); ?>
				</div>
			</div>
