<?php require_once APPPATH.'modules/common/header.php' ?>
	...
	<div class="row">
		<div class="col-lg-12 put-relative">
			...
			<div class="add-href-unit">
				<strong style="margin-top:15px;" class="pull-left">ORGANIZATIONS</strong>
				<a href="<?php echo base_url('organizations/create'); ?>" class="add-vst-button pull-right"><i class="fa fa-plus-square"></i> ADD NEW ORGANIZATION</a>
			</div>
								...
								<table class="table">
									...
									<tbody>
										<?php
											...
											$aplied_by = $this->Organization_model->get_admininfo($item['org_applied_by']);
											$approved_by = $this->Organization_model->get_admininfo($item['org_approved_by']);
										?>
										<tr>
											<td><?php echo $sl; ?></td>
	...
	<script type="text/javascript">
		function searchFilter(page_num) {
			...
			$.ajax({
				type: 'POST',
				url: '<?php echo base_url(); ?>pfilter/get_all_organaizations/'+page_num,
