								...
								<table class="table" id= "upCount" >
									...
									<tbody>
										<?php 
											...
											$chCount = $this->Dashboard_model->image_ch_count($item['submitted_by'],$from_date,$to_date,$doctor,$month,$year);
											$chEntryCount = $this->Dashboard_model->image_ch_entry_count($item['submitted_by'],$from_date,$to_date,$doctor,$month,$year);
											$pCount = $this->Dashboard_model->image_p_count($item['submitted_by'],$from_date,$to_date,$doctor,$month,$year);
											$pEntryCount = $this->Dashboard_model->image_p_entry_count($item['submitted_by'],$from_date,$to_date,$doctor,$month,$year);
