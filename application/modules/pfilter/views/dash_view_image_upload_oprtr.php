...
<?php endif;?>
								<table class="table" style = 'background: white;' id="filtertable1" >
									<thead>
										<tr>
											<th>SL.</th>
											<th>ID</th>
									...
									<tbody>
										...
										<tr>
											...
											<td><?php echo substr($progress['submitted_by'], 0, -10); ?></td>
											<td><?php echo $progress['doctor_name']; ?></td>
											<?php if ($entry):?>
										...
										<?php 
											...
											<tr>
												...
												<td><?php echo substr($ch['submitted_by'], 0, -10); ?></td>
												<td><?php echo $ch['doctor_name']; ?></td>
												<?php if ($entry):?>
