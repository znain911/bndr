								...
								<table class="table" id= "upCount">
									...
									<tbody>
										<?php 
											...
											$chCount = $this->Dashboard_model->image_ch_count_today($item['submitted_by'],$from_date,$org,$operator,$center);
											$chEntryCount = $this->Dashboard_model->image_ch_entry_count_today($item['submitted_by'],$from_date,$org,$operator,$center);
											$pCount = $this->Dashboard_model->image_p_count_today($item['submitted_by'],$from_date,$org,$operator,$center);
											$pEntryCount = $this->Dashboard_model->image_p_entry_count_today($item['submitted_by'],$from_date,$org,$operator,$center);
