		...
		<div class="tabs">
			...
			<div class="sap_tabs">
				...
				<div style="display: block; width: 100%; margin: 0px;">
					...
					<h2 class="registration-title">Doctor Registration</h2>
					...
					<div class="resp-tabs-container">
						...
						<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-1">
							<!-- Form -->
							<?php 
								$attr = array('class' => 'user-reg', 'id' => 'doctorRegistry');
								echo form_open('', $attr);
							?>
								<div id="alert"></div>
								<input type="text" name="full_name" placeholder="Full Name">
								<input type="text" name="phone" placeholder="Phone Number">
								<input type="text" name="bmdc_no" placeholder="BMDC No">
								<input type="text" name="dateof_birth" placeholder="Date Of Birth">
		...
		$(document).ready(function(){
			$("#doctorRegistry").validate({
				...
				submitHandler : function () {
					...
					$.ajax({
						type : "POST",
						url : baseUrl + "register/create_doctor_account",
						data : $('#doctorRegistry').serialize(),
						dataType : "json",
						success : function (data) {
							if(data.status == "ok")
							{
								...
								document.getElementById('doctorRegistry').reset();
