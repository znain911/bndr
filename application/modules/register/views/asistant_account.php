		...
		<div class="tabs">
			...
			<div class="sap_tabs">
				...
				<div style="display: block; width: 100%; margin: 0px;">
					...
					<h2 class="registration-title">Doctor Assistant Registration</h2>
					...
					<div class="resp-tabs-container">
						...
						<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-1">
							<!-- Form -->
							<?php 
								$attr = array('class' => 'user-reg', 'id' => 'assistantRegistry');
								echo form_open('', $attr);
							?>
								<div id="alert"></div>
		...
		$(document).ready(function(){
			$("#assistantRegistry").validate({
				...
				submitHandler : function () {
					...
					$.ajax({
						type : "POST",
						url : baseUrl + "register/create_assistant_account",
						data : $('#assistantRegistry').serialize(),
						dataType : "json",
						success : function (data) {
							if(data.status == "ok")
							{
								...
								document.getElementById('assistantRegistry').reset();
