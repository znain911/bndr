<?php require_once APPPATH.'modules/common/header.php' ?>
						...
						<div class="table-responsive">
							...
							<div id="postList">
								...
								<div class="share-calcuation-panel">
									<?php  
										$allocation_total_reg_amount = $this->Finance_model->get_total_reg_amount('PAID');
										$allocation_total_visit_amount = $this->Finance_model->get_total_visit_amount('PAID');
									...
									<span class="click-to-download" onclick="window.location.href='<?php echo base_url('finance/download?RPTYPE=PAID'); ?>'">Download</span>
								</div>
							</div>
						</div>
					</div>
	...
	<script type="text/javascript">
		function searchFilter(page_num) {
			...
			$.ajax({
				type: 'POST',
				url: '<?php echo base_url(); ?>financeapi/get_all_paids/'+page_num,
