	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default block2">
				<div class="panel-heading text-center">CREATE UPAZILA</div>
				<div class="panel-wrapper collapse in put-relative" aria-expanded="true">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input type="text" name="title" placeholder="Enter Upazila" class="form-control">
							</div>
						</div>
					</div>
					<div class="panel-footer text-right"> 
						<button class="btn btn-info waves-effect waves-light m-t-10" type="submit">Create Upazila</button> 
		...
		$(document).ready(function(){
			$("#createForm").validate({
				...
				submitHandler : function () {
					...
					$.ajax({
						type : "POST",
						url : baseUrl + "setup/upazila/save",
