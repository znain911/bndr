...
class Upazila extends CI_Controller {
	...
	{
		$this->load->view('upazila/upazilas');
	}
	
	public function create()
	{
		$this->load->view('upazila/create');
	}
	...
	public function save()
	{
		...
		$data = array(
					'upazila_district_id' => html_escape($this->input->post('district')),
					'upazila_name'        => html_escape($this->input->post('title')),
					
					'upazila_create_by'   => $this->session->userdata('active_user'),
					'upazila_create_date' => date("Y-m-d H:i:s"),
				);
		$validate = array(
						array(
							'field' => 'title', 
		...
		{
			//save
			$this->Upazila_model->create($data);
	...
	{
		$data['id'] = intval($id);
		$this->load->view('upazila/edit', $data);
	}
	...
	public function delete()
	{
		...
		$this->db->delete('starter_upazilas');
