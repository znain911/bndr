...
class Education extends CI_Controller {
	...
	{
		$this->load->view('education/educations');
	}
	
	public function create()
	{
		$this->load->view('education/create');
	}
	...
	public function save()
	{
		...
		$data = array(
					'education_title'       => html_escape($this->input->post('title')),
					'education_created_by'  => $this->session->userdata('active_user'),
					'education_create_date' => date("Y-m-d H:i:s"),
				);
		$validate = array(
						array(
							'field' => 'title', 
		...
		{
			//save
			$this->Education_model->create($data);
	...
	{
		$data['id'] = intval($id);
		$this->load->view('education/edit', $data);
	}
	...
	public function delete()
	{
		...
		$this->db->delete('starter_educations');
