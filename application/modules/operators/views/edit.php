<?php
	$get_info = $this->Operator_model->get_info($id);
	if($get_info != true)
	{
		redirect('not-found');
	}
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default block2">
				<div class="panel-heading text-center">EDIT OPERATOR</div>
				<div class="panel-wrapper collapse in put-relative" aria-expanded="true">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input type="text" name="full_name" placeholder="Full Name" value="<?php echo $get_info['operator_full_name']; ?>" class="form-control">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-8">Phone Number <span style="color:#f00">*</span></label>
							<div class="col-md-4">
								<input type="text" name="phone" placeholder="Phone Number" value="<?php echo $get_info['operator_phone']; ?>" class="form-control">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-8">Date Of Birth <span style="color:#f00">*</span></label>
							<div class="col-md-4">
								<input type="text" name="dateof_birth" placeholder="yyyy-mm-dd" value="<?php echo $get_info['operator_dateof_birth']; ?>" class="form-control datepicker">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-4">
								<select name="organization" class="form-control" id="selectedOrganization">
									...
									<?php 
										...
										foreach($orgs as $org):
									?>
									<option value="<?php echo $org['org_id']; ?>" <?php echo ($get_info['operator_org_id'] == $org['org_id'])? 'selected' : null; ?>><?php echo $org['org_name']; ?></option>
									<?php endforeach; ?>
								</select>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-4">
								<select name="center" class="form-control" id="cenTers">
									...
									<?php 
										$centers = $this->Organization_model->get_all_centers($get_info['operator_org_id']);
										foreach($centers as $center):
									?>
									<option value="<?php echo $center['orgcenter_id']; ?>" <?php echo ($get_info['operator_org_centerid'] == $center['orgcenter_id'])? 'selected' : null; ?>><?php echo $center['orgcenter_name']; ?></option>
									<?php endforeach; ?>
								</select>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<select name="division" class="form-control" id="selectedDivision">
									...
									?>
									<option value="<?php echo $division['division_id']; ?>" <?php echo ($get_info['operator_division_id'] == $division['division_id'])? 'selected' : null; ?>><?php echo $division['division_name']; ?></option>
									<?php endforeach; ?>
								</select>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-4">
								<select name="district" class="form-control" id="selectedDistrict">
									...
									<?php 
										$districts = $this->Organization_model->get_all_districts($get_info['operator_division_id']);
										foreach($districts as $district):
									?>
									<option value="<?php echo $district['district_id']; ?>" <?php echo ($get_info['operator_district_id'] == $district['district_id'])? 'selected' : null; ?>><?php echo $district['district_name']; ?></option>
									<?php endforeach; ?>
								</select>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-4">
								<select name="upazila" class="form-control" id="selectedUpazila">
									...
									<?php 
										$upazilas = $this->Organization_model->get_all_upazilas($get_info['operator_district_id']);
										foreach($upazilas as $upazila):
									?>
									<option value="<?php echo $upazila['upazila_id']; ?>" <?php echo ($get_info['operator_upazila_id'] == $upazila['upazila_id'])? 'selected' : null; ?>><?php echo $upazila['upazila_name']; ?></option>
									<?php endforeach; ?>
								</select>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-4">
								<textarea name="address" class="form-control" id="" cols="30" rows="5"><?php echo $get_info['operator_address']; ?></textarea>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-8">Postal Code</label>
							<div class="col-md-4">
								<input type="text" name="postal_code" placeholder="Postal Code" value="<?php echo $get_info['operator_postal_code']; ?>" class="form-control">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-6"></label>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input type="text" name="email" value="<?php echo $get_info['operator_email']; ?>" class="form-control" />
							</div>
						</div>
						<div class="form-group">
					...
					<div class="panel-footer text-right"> 
						<button class="btn btn-info waves-effect waves-light m-t-10" type="submit">Update Operator</button> 
						<span onclick="window.location.href='<?php echo base_url('operators'); ?>'" class="btn btn-danger waves-effect waves-light m-t-10">Cancel</span>
					</div>
					<?php echo form_close(); ?>
				</div>
			</div>
