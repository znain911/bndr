<?php require_once APPPATH.'modules/common/header.php' ?>
							...
							<div class="col-lg-12" style="margin-bottom: 10px;">
								...
								<div class="col-md-3 ">
									<strong class="filter-label" style = 'color: white;background-color: #1b75bc;display: flex;justify-content: center; padding: 3%;border: 2px solid #fffdfd;border-radius: 25px;'>
										<a style = 'color: #ffffff; font-size: 16px;' href="<?php echo base_url('administrator/dashboard/oprtr_image'); ?>">Total Upload by Operators</a>
									</strong>
								</div>
	...
	<script type="text/javascript">
		function searchFilter(page_num) {
			...
			$.ajax({
				type: 'POST',
				url: '<?php echo base_url(); ?>pfilter/oprtr_image_today/'+page_num,
				data:'page='+page_num+'&from_date='+from_date+'&operator='+operator+'&centers='+cenTers+'&org='+organization,
				dataType:'json',
				beforeSend: function () {
