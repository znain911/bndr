							...
							<div class="col-lg-12" style="margin-bottom: 10px;">
								...
								<div class="col-md-3 ">
									<strong class="filter-label" style = 'color: white;background-color: #1b75bc;display: flex;justify-content: center; padding: 3%;border: 2px solid #fffdfd;border-radius: 25px;'>
										<a style = 'color: #ffffff; font-size: 16px;' href="<?php echo base_url('administrator/dashboard/doc_image_today'); ?>">Today Upload by Doctors</a>
									</strong>
								</div>
	...
	<script type="text/javascript">
		function searchFilter(page_num) {
			...
			$.ajax({
				...
				data:'page='+page_num+'&from_date='+from_date+'&to_date='+to_date+'&year='+year+'&month='+month+'&doctor='+doctor+'&centers='+cenTers+'&org='+organization,
				dataType:'json',
				beforeSend: function () {
