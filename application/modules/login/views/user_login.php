			...
			<div class="sap_tabs">
				...
				<div style="display: block; width: 100%; margin: 0px;">
					...
					<ul class="resp-tabs-list">
						<li class="resp-tab-item"><h2><a href="<?php echo base_url('login'); ?>"><span>ADMINISTRATOR</span></a></h2></li>
						<li class="resp-tab-item resp-tab-active"><a href="<?php echo base_url('login/type/user'); ?>"><span>USER</span></a></li>
						<div class="clear"> </div>
					</ul>
							...
							?>
								...
								<div class="select_option">
									<select name="role_type" class="form-control">
										...
										<option value="3">Doctor Asistant</option>
									</select>
								</div>
								<ul>
									<li>
								...
								<div class="new-acc">
									<span>Don't have an account? <a href="<?php echo base_url('register'); ?>"><strong>Create new account</strong></a></span>
								</div>
							<?php echo form_close(); ?>
							<!-- //Form -->
						</div>
		...
		$(document).ready(function(){
			$("#userLogin").validate({
				...
				submitHandler : function () {
					...
					$.ajax({
						type : "POST",
						url : baseUrl + "users/login/credentials",
