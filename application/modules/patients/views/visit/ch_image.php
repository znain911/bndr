<?php require_once APPPATH.'modules/common/header.php' ?>
	...
	$patient_info = $this->Visit_model->patientDetailImage($item['patient_id']);
	$footDoctor = $this->Visit_model->footDoctor($item['patient_id']);
	$eyeDoctor = $this->Visit_model->eyeDoctor($item['patient_id']);
	$ftDoctor = $this->Visit_model->ftDoctor($item['patient_id']);
	?>
	<div class="ch">
		<div class="row">
		...
		<div style ="margin-bottom: 1%;margin-top: 1%;">
			<?php $pictures = $this->Visit_model->caseHistoryPic($item['patient_id']);
