<?php require_once APPPATH.'modules/common/header.php' ?>
	...
	<div class="row">
		...
		<div class="col-lg-10 visit-form-col">
			...
			<?php $visit_info = $this->Visit_model->get_visit_info($visit_id); ?>
			...
			<?php 
				...
				//DB query items
				$visit_personal_habit_infos = $this->Visit_model->get_visit_personal_habit_info($visit_id); 
				
				
				//get deferent 
				$deferent_habits = array_diff($visit_personal_habit_infos, $personal_habit_array);
				$final_p_habits = array_merge($personal_habit_array, $deferent_habits);
					...
					<div class="panel-body">
						<div class="row">
							<div id="criteriaIncFour">
								<?php 
									$personal_habit_sl = 1;
									foreach($final_p_habits as $key => $value):
								?>
								<div class="col-md-15 col-sm-3 text-center" style="margin-bottom:15px;">
									<label class="phabit-check"><input type="checkbox" name="phabit_row_name_<?php echo $personal_habit_sl; ?>" value="<?php echo $value; ?>" <?php echo (in_array($value, $visit_personal_habit_infos))? 'checked' : null; ?> />&nbsp;&nbsp;<?php echo $value; ?></label> &nbsp;&nbsp;
									<input type="hidden" name="phabit_row[]" value="<?php echo $personal_habit_sl; ?>" />
								</div>
								<?php 
									$personal_habit_sl++;
									endforeach; 
			...
			<?php 
				...
				//DB query items
				$visit_family_history_infos = $this->Visit_model->get_visit_family_history_info($visit_id); 
			?>
			...
			<div class="panel panel-default block2" id="familyHistory">
				...
				<div class="panel-wrapper collapse in put-relative" aria-expanded="true">
					<div class="panel-body">
						<div class="row">
							<?php 
								$family_history_row = 1;
								foreach($family_history_array as $key => $value): 
							?>
							<div class="col-md-2 text-center family-history-rows" style="margin-bottom:15px;">
								<label class="phabit-check"><input type="checkbox" name="family_history_row_name_<?php echo $family_history_row; ?>" value="<?php echo $value; ?>" <?php echo (in_array($value, $visit_family_history_infos))? 'checked' : null; ?> />&nbsp;&nbsp;<?php echo $value; ?></label> &nbsp;&nbsp;
								<input type="hidden" name="family_history_row[]" value="<?php echo $family_history_row; ?>" />
							</div>
							<?php 
								$family_history_row++;
								endforeach; 
			...
			<?php 
				//DB query items
				$visit_diabetes_history_infos = $this->Visit_model->get_visit_diabetes_history_info($visit_id);
				$visit_diabetes_history_complication_infos = $this->Visit_model->get_visit_diabetes_history_complication_info($visit_id); 				
			?>
				...
				<div class="panel-wrapper collapse in put-relative" aria-expanded="true">
					<div class="panel-body">
						...
						<div class="row">
							...
							<div class="col-lg-2">
								<label class="sel-sympt-diabetes-yes" data-value="1"><input type="checkbox" class="checkbox-sympt-diabetes-yes" name="symptoms_at_diagnosis" value="1" <?php echo ($visit_diabetes_history_infos['dhistory_symptoms_at_diagnosis'] == '1')? 'checked' : null; ?> />&nbsp;&nbsp; YES</label>
							</div>
							<div class="col-lg-2">
								<label class="sel-sympt-diabetes-no" data-value="0"><input type="checkbox" class="checkbox-sympt-diabetes-no" name="symptoms_at_diagnosis" value="0" <?php echo ($visit_diabetes_history_infos['dhistory_symptoms_at_diagnosis'] == '0')? 'checked' : null; ?> />&nbsp;&nbsp; NO</label>
							</div>
							<div class="col-lg-12" style="margin-top: 10px;">
								<div class="row diabetes-type-keywords" style="display:<?php echo ($visit_diabetes_history_infos['dhistory_symptoms_at_diagnosis'] == '1')? 'block' : 'none'; ?>">
									<?php 
										if($visit_diabetes_history_infos['dhistory_symptoms_at_diagnosis_types'] !== 'null'){
											$json_array_symptoms_at_dgnss = json_decode($visit_diabetes_history_infos['dhistory_symptoms_at_diagnosis_types'], true);
										}else{
											$json_array_symptoms_at_dgnss = array();
										}
									?>
									<div class="col-lg-2">
										<label><input type="checkbox" name="symptoms_at_diagnosis_types[]" value="Typical" <?php echo (!empty($json_array_symptoms_at_dgnss) && in_array('Typical', $json_array_symptoms_at_dgnss))? 'checked' : null; ?> />&nbsp;&nbsp; Typical</label>
									</div>
									<div class="col-lg-2">
										<label><input type="checkbox" name="symptoms_at_diagnosis_types[]" value="Atypical" <?php echo (!empty($json_array_symptoms_at_dgnss) && in_array('Atypical', $json_array_symptoms_at_dgnss))? 'checked' : null; ?> />&nbsp;&nbsp; Atypical </label>
									</div>
								</div>
							</div>
						</div>
						<div class="row">
							...
							<div class="col-lg-8">
								<textarea name="other_complaints" class="check-alphanumeric-charactars" cols="30" rows="3" style="width:100%"><?php echo $visit_diabetes_history_infos['dhistory_other_complaints']; ?></textarea>
							</div>
						</div>
					</div>
				</div>
			...
			<?php 
				$visit_general_examinations      = $this->Visit_model->get_visit_general_examination_info($visit_id, $patient_id);
				$get_visit_general_examination_other = $this->Visit_model->get_visit_general_examination_other($visit_id);
							...
							<div id="criteriaIncOne">
									...
									<div class="form-group">
										...
										<?php
											if($visit_general_examinations){
												if($visit_general_examinations['height']){
								...
								<div class="col-lg-6">
									<div class="form-group">
										...
										<?php
											if($visit_general_examinations){
												if($visit_general_examinations['hip']){
												list($hip1,$hip2) = explode(' ', $visit_general_examinations['hip']);
												}else{
													$hip1 = null;
												$hip2 = null;
												}
										...
										<div class="col-md-4">
											<select name="gexam_hip_unit" class="form-control">
												<option value="">Select Unit</option>
												<option value="Inch" <?php echo $hip2 === 'Inch'? 'selected': ''?> >Inch</option>
												<option value="cm" <?php echo $hip2 === 'cm'? 'selected': ''?> >cm</option>
											</select>
										</div>
										<div class="col-md-3">
											<input type="text" class="form-control check-with-decimel" name="gexam_hip_value" placeholder="Hip" value="<?php echo $hip1; ?>" />
										</div>
									</div>
									<input type="hidden" name="gexam_row_name_3" value="Hip" />
								</div>
								<div class="col-lg-6">
									<div class="form-group">
										...
										<?php
											if($visit_general_examinations){
												if($visit_general_examinations['waist']){
												list($waist1,$waist2) = explode(' ', $visit_general_examinations['waist']);
												}else{
													$waist1 = null;
												$waist2 = null;
												}
										...
										<div class="col-md-4">
											<select name="gexam_waist_unit" class="form-control sel-gexam-height">
												<option value="">Select Unit</option>
												<option value="Inch" <?php echo $waist2 === 'Inch'? 'selected': ''?> >Inch</option>
												<option value="cm" <?php echo $waist2 === 'cm'? 'selected': ''?> >cm</option>
											</select>
										</div>
										<div class="col-md-3">
											<input type="text" class="form-control check-with-decimel" name="gexam_waist_value" placeholder="Waist" value="<?php echo $waist1; ?>" />
										</div>
									</div>
								</div>
								<div class="col-lg-6">
								...
								<div class="col-lg-6">
									<div class="form-group">
										...
										<?php
											if($visit_general_examinations){
												if($visit_general_examinations['standing_sbp']){
												list($st1,$st2) = explode(' ', $visit_general_examinations['standing_sbp']);
												}else{
													$st1 = null;
												$st2 = null;
												}
										...
										<div class="col-md-3">
											<input type="text" class="form-control check-with-decimel" value = "<?php echo $st1;?>" name="gexam_st_sbp_value" placeholder="Sitting SBP" />
										</div>
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group">
										...
										<?php
											if($visit_general_examinations){
												if($visit_general_examinations['standing_dbp']){
												list($st3,$st4) = explode(' ', $visit_general_examinations['standing_dbp']);
												}else{
													$st3 = null;
												$st2 = null;
												}
										...
										<div class="col-md-3">
											<input type="text" class="form-control check-with-decimel" value = "<?php echo $st3;?>" name="gexam_st_dbp_value" placeholder="Sitting DBP" />
										</div>
									</div>
								</div>
								<div class="col-lg-6">
								...
								<div class="col-lg-6">
									<textarea name="other_physical_examinations" class="check-alphanumeric-charactars" cols="30" rows="3" style="width:100%"><?php echo $get_visit_general_examination_other; ?></textarea>
								</div>
							</div>
						</div>
					</div>
			...
			<?php 
				//DB query items
				$visit_foot_examination_infos = $this->Visit_model->get_visit_foot_examination_info($visit_id); 
			?>
						...
						<div class="row">
							<div class="col-lg-offset-6 col-lg-6">
								<div class="form-group">
									...
									<div class="col-md-7">
										<input type="text" name="footexm_date" value="<?php echo ($visit_foot_examination_infos['footexm_date'])? date('d/m/Y', strtotime($visit_foot_examination_infos['footexm_date'])): null; ?>" placeholder="DD/MM/YYYY" class="form-control text-center datepicker check-date-is-valid">
									</div>
								</div>
							</div>
							<div class="col-lg-12">
							...
							<div class="col-lg-6" style="margin-bottom:15px;">
								...
								<p>
									<label class="arteria-dorsalis-predis-present-left"><input class="checkbox-arteria-dorsalis-predis-present-left" type="checkbox" name="arteria_dorsalis_predis_present_left" value="Left" <?php echo ($visit_foot_examination_infos['arteria_dorsalis_predis_present_left'] == 'Left')? 'checked' : null; ?> />&nbsp;&nbsp;Present-Left</label> &nbsp;&nbsp;&nbsp;&nbsp;
									<label class="arteria-dorsalis-predis-present-right"><input class="checkbox-arteria-dorsalis-predis-present-right" type="checkbox" name="arteria_dorsalis_predis_present_right" value="Right" <?php echo ($visit_foot_examination_infos['arteria_dorsalis_predis_present_right'] == 'Right')? 'checked' : null; ?> />&nbsp;&nbsp;Present-Right</label> &nbsp;&nbsp;&nbsp;&nbsp;
									<label class="arteria-dorsalis-predis-absent-left"><input class="checkbox-arteria-dorsalis-predis-absent-left" type="checkbox" name="arteria_dorsalis_predis_absent_left" value="Left" <?php echo ($visit_foot_examination_infos['arteria_dorsalis_predis_absent_left'] == 'Left')? 'checked' : null; ?> />&nbsp;&nbsp;Absent-Left</label>&nbsp;&nbsp;&nbsp;&nbsp;
									<label class="arteria-dorsalis-predis-absent-right"><input class="checkbox-arteria-dorsalis-predis-absent-right" type="checkbox" name="arteria_dorsalis_predis_absent_right" value="Right" <?php echo ($visit_foot_examination_infos['arteria_dorsalis_predis_absent_right'] == 'Right')? 'checked' : null; ?> />&nbsp;&nbsp;Absent-Right</label>
								</p>
							</div>
							<div class="col-lg-6" style="margin-bottom:15px;">
								<p><strong>Posterior Tribila</strong></p>
								<p>
									<label class="posterior-tribila-present-left"><input class="checkbox-posterior-tribila-present-left" type="checkbox" name="posterior_tribila_present_left" value="Left" <?php echo ($visit_foot_examination_infos['posterior_tribila_present_left'] == 'Left')? 'checked' : null; ?> />&nbsp;&nbsp;Present-Left</label> &nbsp;&nbsp;&nbsp;&nbsp;
									<label class="posterior-tribila-present-right"><input class="checkbox-posterior-tribila-present-right" type="checkbox" name="posterior_tribila_present_right" value="Right" <?php echo ($visit_foot_examination_infos['posterior_tribila_present_right'] == 'Right')? 'checked' : null; ?> />&nbsp;&nbsp;Present-Right</label> &nbsp;&nbsp;&nbsp;&nbsp;
									<label class="posterior-tribila-absent-left"><input class="checkbox-posterior-tribila-absent-left" type="checkbox" name="posterior_tribila_absent_left" value="Left" <?php echo ($visit_foot_examination_infos['posterior_tribila_absent_left'] == 'Left')? 'checked' : null; ?> />&nbsp;&nbsp;Absent-Left</label>&nbsp;&nbsp;&nbsp;&nbsp;
									<label class="posterior-tribila-absent-right"><input class="checkbox-posterior-tribila-absent-right" type="checkbox" name="posterior_tribila_absent_right" value="Right" <?php echo ($visit_foot_examination_infos['posterior_tribila_absent_right'] == 'Right')? 'checked' : null; ?> />&nbsp;&nbsp;Absent-Right</label>
								</p>
							</div>
							...
							<div class="col-lg-6" style="margin-bottom:15px;">
								...
								<p>
									<label class="monofilament-present-left"><input class="checkbox-monofilament-present-left" type="checkbox" name="monofilament_present_left" value="Left" <?php echo ($visit_foot_examination_infos['monofilament_present_left'] == 'Left')? 'checked' : null; ?> />&nbsp;&nbsp;Present-Left</label> &nbsp;&nbsp;&nbsp;&nbsp;
									<label class="monofilament-present-right"><input class="checkbox-monofilament-present-right" type="checkbox" name="monofilament_present_right" value="Right" <?php echo ($visit_foot_examination_infos['monofilament_present_right'] == 'Right')? 'checked' : null; ?> />&nbsp;&nbsp;Present-Right</label> &nbsp;&nbsp;&nbsp;&nbsp;
									<label class="monofilament-absent-left"><input class="checkbox-monofilament-absent-left" type="checkbox" name="monofilament_absent_left" value="Left" <?php echo ($visit_foot_examination_infos['monofilament_absent_left'] == 'Left')? 'checked' : null; ?> />&nbsp;&nbsp;Absent-Left</label>&nbsp;&nbsp;&nbsp;&nbsp;
									<label class="monofilament-absent-right"><input class="checkbox-monofilament-absent-right" type="checkbox" name="monofilament_absent_right" value="Right" <?php echo ($visit_foot_examination_infos['monofilament_absent_right'] == 'Right')? 'checked' : null; ?> />&nbsp;&nbsp;Absent-Right</label>
								</p>
							</div>
							<div class="col-lg-6" style="margin-bottom:15px;">
								<p><strong>Tuning Fork</strong></p>
								<p>
									<label class="tuning-fork-present-left"><input class="checkbox-tuning-fork-present-left" type="checkbox" name="tuning_fork_present_left" value="Left" <?php echo ($visit_foot_examination_infos['tuning_fork_present_left'] == 'Left')? 'checked' : null; ?> />&nbsp;&nbsp;Present-Left</label> &nbsp;&nbsp;&nbsp;&nbsp;
									<label class="tuning-fork-present-right"><input class="checkbox-tuning-fork-present-right" type="checkbox" name="tuning_fork_present_right" value="Right" <?php echo ($visit_foot_examination_infos['tuning_fork_present_right'] == 'Right')? 'checked' : null; ?> />&nbsp;&nbsp;Present-Right</label> &nbsp;&nbsp;&nbsp;&nbsp;
									<label class="tuning-fork-absent-left"><input class="checkbox-tuning-fork-absent-left" type="checkbox" name="tuning_fork_absent_left" value="Left" <?php echo ($visit_foot_examination_infos['tuning_fork_absent_left'] == 'Left')? 'checked' : null; ?> />&nbsp;&nbsp;Absent-Left</label>&nbsp;&nbsp;&nbsp;&nbsp;
									<label class="tuning-fork-absent-right"><input class="checkbox-tuning-fork-absent-right" type="checkbox" name="tuning_fork_absent_right" value="Right" <?php echo ($visit_foot_examination_infos['tuning_fork_absent_right'] == 'Right')? 'checked' : null; ?> />&nbsp;&nbsp;Absent-Right</label>
								</p>
							</div>
							...
							<div class="col-lg-12">
								<div class="form-group">
									...
									<div class="col-lg-7">
										<textarea name="footexm_other_content" class="check-alphanumeric-charactars" cols="30" rows="3" style="width:100%"><?php echo $visit_foot_examination_infos['footexm_other_content']; ?></textarea>
									</div>
								</div>
							</div>
							<div class="col-lg-12">
								<div class="form-group">
									...
									<div class="col-lg-3">
										<input type="text" class="form-control src-doctor-name-by-center" name="footexm_doctor_name" data-section="hidden-foot-examination-doctor" value="<?php echo $visit_foot_examination_infos['footexm_doctor_name']; ?>" placeholder="Type name of doctor" />
										<input type="hidden" id="hidden-foot-examination-doctor" name="footexm_doctor_id" value="<?php echo $visit_foot_examination_infos['footexm_doctor_id']; ?>" />
									</div>
								</div>
							</div>
						</div>
			...
			<?php 
				//DB query items
				$visit_dietary_history_infos = $this->Visit_model->get_visit_dietary_history_info($visit_id); 
			?>
					...
					<div class="panel-body" id = 'deactive-enter-dih'>
						<div class="row">
							...
							<div id="criteriaIncSix">
								<?php
									$itmsl= 1;
									foreach($visit_dietary_history_infos as $item):
								?>
								<div class="dietary-hstr">
									<label class="control-label col-md-offset-2 col-md-2"><strong><?php echo $itmsl; ?>.</strong> <?php echo $item['diehist_name']; ?></label>
									<div class="col-md-2">
										<input type="text" class="form-control prev-diatory-history-daily" data-imp-val-row="<?php echo $itmsl; ?>" name="prev_diatory_history_daily_<?php echo $itmsl; ?>" placeholder="Per Day" value="<?php echo $item['diehist_daily']; ?>" />
									</div>
									<div class="col-lg-2">
										<input type="text" class="form-control prev-diatory-history-weekly prev-diatory-history-weekly-<?php echo $itmsl; ?>" data-imp-val-row="row+" name="prev_diatory_history_weekly_<?php echo $itmsl; ?>" placeholder="Per Week" value="<?php echo $item['diehist_weekly']; ?>" />
									</div>
									...
									<input type="hidden" name="prev_diatory_history_row[]" value="<?php echo $itmsl; ?>" />
									<input type="hidden" name="prev_diatory_history_row_name_<?php echo $itmsl; ?>" value="<?php echo $item['diehist_name']; ?>" />
								</div>
								<?php 
									$itmsl++;
									endforeach; 
			...
			<?php 
				//DB query items
				$visit_physical_activity_infos = $this->Visit_model->get_visit_physical_activity_info($visit_id); 
			?>
					...
					<div class="panel-body" id = 'deactive-enter-pah'>
						...
						<div class="row physical-activities-content">
							...
							<div id="criteriaIncEight">
								<?php  
									$physical_actsl = 1;
									foreach($visit_physical_activity_infos as $item):
								?>
								<div class="col-lg-3 put-relative physical-act-item">
									<div style="margin-bottom: 15px; text-align: center; border: 1px solid rgb(238, 238, 238); border-radius: 4px; line-height: 15px; height: 105px; padding: 10px;">
										<p><strong><?php echo $item['physical_act_type']; ?>:</strong></p>
										<p><strong><?php echo $item['physical_act_duration_a_day']; ?></strong>
											<input type="hidden" name="prev_phisical_acitivity_value_<?php echo $physical_actsl; ?>" value="<?php echo $item['physical_act_duration_a_day']; ?>">
										</p>
										<p><strong><?php echo $item['physical_act_duration_a_week']; ?></strong>
											<input type="hidden" name="prev_phisical_acitivity_value_per_week_<?php echo $physical_actsl; ?>" value="<?php echo $item['physical_act_duration_a_week']; ?>">
										</p><span class="rmv-itm mdi mdi-delete"></span>
										<input type="hidden" name="prev_phisical_acitivity_row[]" value="<?php echo $physical_actsl; ?>">
										<input type="hidden" name="prev_phisical_acitivity_row_name_<?php echo $physical_actsl; ?>" value="<?php echo $item['physical_act_type']; ?>">
									</div>
								</div>
								<?php 
									$physical_actsl++;
			...
			<?php 
				//DB query items
				$visit_eye_examination_infos = $this->Visit_model->get_visit_eye_examination_info($visit_id); 
			?>
						...
						<div class="row">
							<div class="col-lg-offset-6 col-lg-6">
								<div class="form-group">
									<label class="control-label col-md-5">Date</label>
									<div class="col-md-7">
										<input type="text" name="eyeexam_date" value="<?php echo ($visit_eye_examination_infos['eyeexam_date'])? date('d/m/Y', strtotime($visit_eye_examination_infos['eyeexam_date'])): null; ?>" placeholder="DD/MM/YYYY" class="form-control text-center datepicker check-date-is-valid">
									</div>
								</div>
							</div>
							<div class="col-lg-12">
								<div class="form-group">
									...
									<div class="col-lg-7">
										<textarea name="eyeexam_right_eye" class="check-alphanumeric-charactars" cols="30" rows="3" style="width:100%"><?php echo $visit_eye_examination_infos['eyeexam_right_eye']; ?></textarea>
									</div>
								</div>
							</div>
							<div class="col-lg-12">
								<div class="form-group">
									...
									<div class="col-lg-7">
										<textarea name="eyeexam_left_eye" class="check-alphanumeric-charactars" cols="30" rows="3" style="width:100%"><?php echo $visit_eye_examination_infos['eyeexam_left_eye']; ?></textarea>
									</div>
								</div>
							</div>
							<div class="col-lg-12">
								<div class="form-group">
									...
									<div class="col-lg-7">
										<textarea name="eyeexam_other" class="check-alphanumeric-charactars" cols="30" rows="3" style="width:100%"><?php echo $visit_eye_examination_infos['eyeexam_other']; ?></textarea>
									</div>
								</div>
							</div>
							<div class="col-lg-12">
								<div class="form-group">
									...
									<div class="col-lg-7">
										<textarea name="eyeexam_treatment" class="check-alphanumeric-charactars" cols="30" rows="3" style="width:100%"><?php echo $visit_eye_examination_infos['eyeexam_treatment']; ?></textarea>
									</div>
								</div>
							</div>
							<div class="col-lg-12">
								<div class="form-group">
									<label class="control-label col-lg-2" style="text-align:right">Name Of Doctor</label>
									<div class="col-lg-3">
										<input type="text" class="form-control src-doctor-name" name="eyeexam_doctor_name" value="<?php echo $visit_eye_examination_infos['eyeexam_doctor_name']; ?>" data-section="hidden-eye-examination-doctor" placeholder="Type name of doctor" />
										<input type="hidden" id="hidden-eye-examination-doctor" name="eyeexam_doctor_id" value="<?php echo $visit_eye_examination_infos['eyeexam_doctor_id']; ?>" />
									</div>
								</div>
							</div>
						</div>
			...
			<?php 
				...
				$visit_laboratory_investigation_ecg_infos = $this->Visit_model->get_visit_laboratory_investigation_ecg_info($visit_id);
				$visit_laboratory_investigation_usg_infos = $this->Visit_model->get_visit_laboratory_investigation_usg_info($visit_id);
				$blood_groups = array(
									'Unknown',
									'A+',
									'A-',
				...
				foreach($visit_laboratory_investigation_names as $key => $value){
					if(in_array(html_escape($key), $dc_sub_array))
					{
						continue;
					}
			...
			<div class="panel panel-default block2" id="laboratoryInvestigation">
				...
				<div class="panel-wrapper collapse in put-relative" aria-expanded="true">
					<div class="panel-body" id = 'deactive-enter-lab'>
						<div class="row">
							<div id="criteriaIncTwo">
								...
								<div class="col-lg-6 ">
									<div class="form-group">
										...
										<?php if($visit_laboratory_investigation_main){
													if($visit_laboratory_investigation_main['post_meal_bg']){
														list($pmb) = explode(' ',$visit_laboratory_investigation_main['post_meal_bg']);
													}else {
														$pmb = null;
													}
											}else {
										...
										<div class="col-md-7">
											<input type="text" class="form-control check-with-double-decimel" name="pmb" placeholder="mmol" value="<?php echo $pmb;?>" />
										</div>
									</div>
								...
								<div class="col-lg-6 ">
									<div class="form-group">
										...
										<?php if($visit_laboratory_investigation_main){
													if($visit_laboratory_investigation_main['hb']){
														list($hb) = explode(' ',$visit_laboratory_investigation_main['hb']);
													}else {
														$hb = null;
													}
											}else {
										...
										<div class="col-md-7">
											<input type="text" class="form-control check-with-double-decimel" name="hb" placeholder="%" value="<?php echo $hb;?>" />
										</div>
									</div>
								...
								<div class="col-lg-6 ">
									<div class="form-group">
										...
										<div class="col-md-7">
											<input type="text" class="form-control check-with-double-decimel-for-tc" name="tc" placeholder="TC" value="<?php if($visit_laboratory_investigation_main){echo $visit_laboratory_investigation_main['tc'];}?>"/>
										</div>
									</div>
								...
								<div class="col-lg-6 ">
									<span class="inline-input-for-lab"><span class="label-txt"><strong>DC</strong> – N</span> <input type="text" name="dcn" class="check-with-double-decimel-limit-hundred inline-input-text-for-lab" value="<?php if($visit_laboratory_investigation_main){echo $visit_laboratory_investigation_main['dc_n'];}?>" /> %</span>
									<span class="inline-input-for-lab"><span class="label-txt">Z</span> <input type="text" name="dcz" class="check-with-double-decimel-limit-hundred inline-input-text-for-lab" value="<?php if($visit_laboratory_investigation_main){echo $visit_laboratory_investigation_main['dc_z'];}?>"  /> %</span>
									<span class="inline-input-for-lab"><span class="label-txt">M</span> <input type="text" name="dcm" class="check-with-double-decimel-limit-hundred inline-input-text-for-lab" value="<?php if($visit_laboratory_investigation_main){echo $visit_laboratory_investigation_main['dc_m'];}?>"  /> %</span>
									<span class="inline-input-for-lab"><span class="label-txt">E</span> <input type="text" name="dce" class="check-with-double-decimel-limit-hundred inline-input-text-for-lab" value="<?php if($visit_laboratory_investigation_main){echo $visit_laboratory_investigation_main['dc_e'];}?>"  /> %</span>
								...
								<div class="col-lg-6 ">
									<div class="form-group">
										...
										<div class="col-md-7">
											<input type="text" class="form-control check-with-double-decimel-max-300" name="esr" placeholder="" value="<?php if($visit_laboratory_investigation_main){echo $visit_laboratory_investigation_main['esr'];}?>" />
										</div>
									</div>
								...
								<div class="col-lg-6 ">
									<div class="form-group">
										...
										<div class="col-md-7">
											<input type="text" class="form-control check-with-double-decimel" name="uma" placeholder="" value="<?php if($visit_laboratory_investigation_main){echo $visit_laboratory_investigation_main['urine_micro_albumin'];}?>" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-7">
											<select class="form-control" name="bg">
												...
												<option value="A+" <?php if($visit_laboratory_investigation_main){echo $visit_laboratory_investigation_main['blood_group'] === 'A+'? 'selected' : null;}?>>A+</option>
												<option value="A-" <?php if($visit_laboratory_investigation_main){echo $visit_laboratory_investigation_main['blood_group'] === 'A-'? 'selected' : null;}?>>A-</option>
												<option value="B+" <?php if($visit_laboratory_investigation_main){echo $visit_laboratory_investigation_main['blood_group'] === 'B+'? 'selected' : null;}?>>B+</option>
												<option value="B-" <?php if($visit_laboratory_investigation_main){echo $visit_laboratory_investigation_main['blood_group'] === 'B-'? 'selected' : null;}?>>B-</option>
												<option value="O+" <?php if($visit_laboratory_investigation_main){echo $visit_laboratory_investigation_main['blood_group'] === 'O+'? 'selected' : null;}?>>O+</option>
												<option value="O-" <?php if($visit_laboratory_investigation_main){echo $visit_laboratory_investigation_main['blood_group'] === 'O-'? 'selected' : null;}?>>O-</option>
												<option value="AB+" <?php if($visit_laboratory_investigation_main){echo $visit_laboratory_investigation_main['blood_group'] === 'AB+'? 'selected' : null;}?>>AB+</option>
												<option value="AB-" <?php if($visit_laboratory_investigation_main){echo $visit_laboratory_investigation_main['blood_group'] === 'AB-'? 'selected' : null;}?>>AB-</option>
											</select>
										</div>
									</div>
			...
			<?php 
				//DB query items
				$visit_drug_history_infos = $this->Visit_model->get_visit_drug_history_info($visit_id); 
			?>
			<div id="drugHistory" class="panel panel-default block2">
				...
				<div class="panel-wrapper collapse in put-relative" aria-expanded="true">
					<div class="panel-body" id ='block-enter-dh'>
						<div class="row">
							<div class="col-lg-offset-6 col-lg-6">
								<div class="form-group">
									<label class="control-label col-md-5">Date</label>
									<div class="col-md-7">
										<input type="text" name="drughistory_date" value="<?php echo ($visit_drug_history_infos['drughistory_date'])? date('d/m/Y', strtotime($visit_drug_history_infos['drughistory_date'])) : null; ?>" placeholder="DD/MM/YYYY" class="form-control text-center datepicker check-date-is-valid">
									</div>
								</div>
							</div>
						</div>
							...
							<div class="input-row-fields-9" style="display:<?php echo (count($prev_oads_array) !== 0)? 'block' : 'none'; ?>">
								<div id="prevOads">
									<?php 
										...
										foreach($prev_medication_oads as $item):
									?>
									<div class="row-field prev-oads-row">
										<div class="col-lg-3"><input type="text" name="oads_name_<?php echo $prev_oads; ?>" value="<?php echo $item['oads_name']; ?>" placeholder="Add OADs" class="form-control load-drugs" /></div>
										<div class="col-lg-2"><input type="text" name="oads_value_<?php echo $prev_oads; ?>" value="<?php echo $item['oads_dose']; ?>" placeholder="Dose" class="form-control" /></div>
										
										<div class="col-lg-3" style="padding-top: 15px;">
											<div class="inline-sc" style="width: 35%;">
											<span style="display: block;width: 50%;float: left;">খাওয়ার</span> 
											<input type="text" value ="<?php echo $item['oads_advice_codition_time'];?>" name="oads_condition_time_1" placeholder="" class="form-control" style="float: left;width: 45%;height: 30px;margin-top: -10px;text-align: center;">
											</div>
											<div class="inline-sc" style="width: 20%;">
												<select name="oads_condition_time_type_1" class="form-control" style="text-align: center;margin-top: -14px;">
													<option value="মিনিট" <?php echo ($item['oads_advice_codition_time_type'] == 'মিনিট')? 'selected' : null; ?>>মিনিট</option>
													<option value="ঘন্টা" <?php echo ($item['oads_advice_codition_time_type'] == 'ঘন্টা')? 'selected' : null; ?> >ঘন্টা</option>
												</select>
											</div>
											<div class="inline-sc" style="width: 20%;">
												<select name="oads_condition_apply_<?php echo $prev_oads; ?>" class="form-control" style="text-align: center;margin-top: -14px;">
										...
										<div class="col-lg-2" style="padding-top: 15px;">
											...
											<input type="text" name="oads_duration_<?php echo $prev_oads; ?>" value="<?php echo $item['oads_duration']; ?>" style="float: left;width: 45%;height: 30px;margin-top: -10px;text-align: center;" class="form-control">
											<div class="inline-sc" style="width: 22%;">
												<select name="oads_duration_type_<?php echo $prev_oads; ?>" class="form-control" style="text-align: center;margin-top: -15px;">
										...
										<?php if($prev_oads == 1): ?>
										<div class="col-lg-1"><span class="prev-oads-add-more-htn add-more-bttn" style="cursor:pointer"><i class="mdi mdi-plus"></i>More</span></div>
										<?php else: ?>
							...
							<div class="input-row-fields-10" style="display:<?php echo (count($prev_insulins_array) !== 0)? 'block' : 'none'; ?>">
								<div id="prevInsulin">
									<?php 
										...
										foreach($prev_medication_insulins as $item):
									?>
									<div class="row-field prev-insulin-row">
										<div class="col-lg-3"><input type="text" name="prev_insulin_name_<?php echo $prev_insulin; ?>" value="<?php echo $item['insulin_name']; ?>" placeholder="Add Insulin" class="form-control load-drugs-insulin" /></div>
										<div class="col-lg-2"><input type="text" name="prev_insulin_value_<?php echo $prev_insulin; ?>" value="<?php echo $item['insulin_dose']; ?>" placeholder="Dose" class="form-control" /></div>
										
										<div class="col-lg-3" style="padding-top: 15px;">
											<div class="inline-sc" style="width: 35%;">
											<span style="display: block;width: 50%;float: left;">খাওয়ার</span> 
											<input type="text" name="prev_insulin_condition_time_<?php echo $prev_insulin; ?>" value="<?php echo $item['insulin_advice_codition_time']; ?>" placeholder="" class="form-control" style="float: left;width: 45%;height: 30px;margin-top: -10px;text-align: center;"></div>
											<div class="inline-sc" style="width: 20%;">
												<select name="prev_insulin_condition_time_type_<?php echo $prev_insulin; ?>" class="form-control" style="text-align: center;margin-top: -14px;">
											...
											<div class="inline-sc" style="width: 20%;">
												<select name="prev_insulin_condition_apply_<?php echo $prev_insulin; ?>" class="form-control" style="text-align: center;margin-top: -14px;">
										...
										<div class="col-lg-2" style="padding-top: 15px;">
											<span style="display: block;width: 30%;float: left;">চলবে</span>
											<input type="text" name="prev_insulin_duration_<?php echo $prev_insulin; ?>" value="<?php echo $item['insulin_duration']; ?>" style="float: left;width: 45%;height: 30px;margin-top: -10px;text-align: center;" class="form-control">
											<div class="inline-sc" style="width: 22%;">
												<select name="prev_insulin_duration_type_<?php echo $prev_insulin; ?>" class="form-control" style="text-align: center;margin-top: -15px;">
						...
						<div class="row other-medication-box">
							...
							<div class="input-row-fields" style="display:<?php echo (count($prev_antihtns_array) !== 0)? 'block' : 'none'; ?>">
								<div id="antiHtnFields">
									<?php 
										$prev_antihtn = 1;
										if(is_array($prev_medication_antihtns) && count($prev_medication_antihtns) !== 0):
										foreach($prev_medication_antihtns as $item):
									?>
									<div class="row-field prev-anti-htn-row">
										<div class="col-lg-3"><input type="text" name="anti_htn_name_<?php echo $prev_antihtn; ?>" value="<?php echo $item['anti_htn_name']; ?>" placeholder="Add Anti HTN" class="form-control load-drugs" /></div>
										<div class="col-lg-2"><input type="text" name="anti_htn_value_<?php echo $prev_antihtn; ?>" value="<?php echo $item['anti_htn_dose']; ?>" placeholder="Dose" class="form-control" /></div>
										
										<div class="col-lg-3" style="padding-top: 15px;">
											<div class="inline-sc" style="width: 35%;">
											<span style="display: block;width: 50%;float: left;">খাওয়ার</span> 
											<input type="text" name="anti_htn_condition_time_<?php echo $prev_antihtn; ?>" value="<?php echo $item['anti_htn_advice_codition_time']; ?>" placeholder="" class="form-control" style="float: left;width: 45%;height: 30px;margin-top: -10px;text-align: center;"></div>
											<div class="inline-sc" style="width: 20%;">
												<select name="anti_htn_condition_time_type_<?php echo $prev_antihtn; ?>" class="form-control" style="text-align: center;margin-top: -14px;">
											...
											<div class="inline-sc" style="width: 20%;">
												<select name="anti_htn_condition_apply_<?php echo $prev_antihtn; ?>" class="form-control" style="text-align: center;margin-top: -14px;">
										...
										<div class="col-lg-2" style="padding-top: 15px;">
											<span style="display: block;width: 30%;float: left;">চলবে</span>
											<input type="text" name="anti_htn_duration_<?php echo $prev_antihtn; ?>" value="<?php echo $item['anti_htn_duration']; ?>" style="float: left;width: 45%;height: 30px;margin-top: -10px;text-align: center;" class="form-control">
											<div class="inline-sc" style="width: 22%;">
												<select name="anti_htn_duration_type_<?php echo $prev_antihtn; ?>" class="form-control" style="text-align: center;margin-top: -15px;">
						...
						<div class="row other-medication-box">
							<div class="col-lg-12">
								<strong>Anti-lipid : </strong> &nbsp;&nbsp;<label class="sel-sympt-5" data-value="1"><input type="radio" name="prev_is_anti_lipids" value="1" <?php echo (count($prev_antilipids_array) !== 0)? 'checked' : null; ?> />&nbsp; Yes</label> &nbsp;&nbsp; <label class="sel-sympt-5" data-value="0"><input type="radio" name="prev_is_anti_lipids" value="0" <?php echo (count($prev_antilipids_array) == 0)? 'checked' : null; ?> />&nbsp; No</label>
							</div>
							<div class="input-row-fields-2" style="display:<?php echo (count($prev_antilipids_array) !== 0)? 'block' : 'none'; ?>">
								<div id="antiLipidsFields">
									<?php 
										...
										foreach($prev_medication_antilipids as $item):
									?>
									<div class="row-field prev-anti-lipid-row">
										<div class="col-lg-3"><input type="text" name="lipids_name_<?php echo $prev_antilipids; ?>" value="<?php echo $item['anti_lipid_name']; ?>" placeholder="Add Anti Lipids" class="form-control load-drugs" /></div>
										<div class="col-lg-2"><input type="text" name="lipids_value_<?php echo $prev_antilipids; ?>" value="<?php echo $item['anti_lipid_dose']; ?>" placeholder="Dose" class="form-control" /></div>
										
										<div class="col-lg-3" style="padding-top: 15px;">
											<div class="inline-sc" style="width: 35%;">
											<span style="display: block;width: 50%;float: left;">খাওয়ার</span> 
											<input type="text" name="lipids_condition_time_<?php echo $prev_antilipids; ?>" value="<?php echo $item['anti_lipid_advice_codition_time']; ?>" placeholder="" class="form-control" style="float: left;width: 45%;height: 30px;margin-top: -10px;text-align: center;"></div>
											<div class="inline-sc" style="width: 20%;">
												<select name="lipids_condition_time_type_<?php echo $prev_antilipids; ?>" class="form-control" style="text-align: center;margin-top: -14px;">
											...
											<div class="inline-sc" style="width: 20%;">
												<select name="lipids_condition_apply_<?php echo $prev_antilipids; ?>" class="form-control" style="text-align: center;margin-top: -14px;">
										...
										<div class="col-lg-2" style="padding-top: 15px;">
											<span style="display: block;width: 30%;float: left;">চলবে</span>
											<input type="text" name="lipids_duration_<?php echo $prev_antilipids; ?>" value="<?php echo $item['anti_lipid_duration']; ?>" style="float: left;width: 45%;height: 30px;margin-top: -10px;text-align: center;" class="form-control">
											<div class="inline-sc" style="width: 22%;">
												<select name="lipids_duration_type_<?php echo $prev_antilipids; ?>" class="form-control" style="text-align: center;margin-top: -15px;">
						...
						<div class="row other-medication-box">
							<div class="col-lg-12">
								<strong>Anti-platelet : </strong> &nbsp;&nbsp;<label class="sel-sympt-6" data-value="1"><input type="radio" name="prev_is_aspirine" value="1" <?php echo (count($prev_antiplatelets_array) !== 0)? 'checked' : null; ?> />&nbsp; Yes</label> &nbsp;&nbsp; <label class="sel-sympt-6" data-value="0"><input type="radio" name="prev_is_aspirine" value="0" <?php echo (count($prev_antiplatelets_array) == 0)? 'checked' : null; ?> />&nbsp; No</label>
							</div>
							<div class="input-row-fields-3" style="display:<?php echo (count($prev_antiplatelets_array) !== 0)? 'block' : 'none'; ?>">
								<div id="aspirineFields">
									<?php 
										...
										foreach($prev_medication_antiplatelets as $item):
									?>
									<div class="row-field prev-antiplatelet-row">
										<div class="col-lg-3"><input type="text" name="aspirine_name_<?php echo $prev_antiplatelets; ?>" value="<?php echo $item['antiplatelets_name']; ?>" placeholder="Add Antiplatelets" class="form-control load-drugs" /></div>
										<div class="col-lg-2"><input type="text" name="aspirine_value_<?php echo $prev_antiplatelets; ?>" value="<?php echo $item['antiplatelets_dose']; ?>" placeholder="Dose" class="form-control" /></div>
										
										<div class="col-lg-3" style="padding-top: 15px;">
											<div class="inline-sc" style="width: 35%;">
											<span style="display: block;width: 50%;float: left;">খাওয়ার</span> 
											<input type="text" name="aspirine_condition_time_<?php echo $prev_antiplatelets; ?>" value="<?php echo $item['antiplatelets_advice_codition_time']; ?>" placeholder="" class="form-control" style="float: left;width: 45%;height: 30px;margin-top: -10px;text-align: center;"></div>
											<div class="inline-sc" style="width: 20%;">
												<select name="aspirine_condition_time_type_<?php echo $prev_antiplatelets; ?>" class="form-control" style="text-align: center;margin-top: -14px;">
											...
											<div class="inline-sc" style="width: 20%;">
												<select name="aspirine_condition_apply_<?php echo $prev_antiplatelets; ?>" class="form-control" style="text-align: center;margin-top: -14px;">
										...
										<div class="col-lg-2" style="padding-top: 15px;">
											<span style="display: block;width: 30%;float: left;">চলবে</span>
											<input type="text" name="aspirine_duration_<?php echo $prev_antiplatelets; ?>" value="<?php echo $item['antiplatelets_duration']; ?>" style="float: left;width: 45%;height: 30px;margin-top: -10px;text-align: center;" class="form-control">
											<div class="inline-sc" style="width: 22%;">
												<select name="aspirine_duration_type_<?php echo $prev_antiplatelets; ?>" class="form-control" style="text-align: center;margin-top: -15px;">
							...
							<div class="input-row-fields-4" style="display:<?php echo (count($prev_antiobesities_array) !== 0)? 'block' : 'none'; ?>">
								<div id="antiObesityFields">
									<?php 
										...
										foreach($prev_medication_antiobesities as $item):
									?>
									<div class="row-field prev-anti-obesity-row">
										<div class="col-lg-3"><input type="text" name="obesity_name_<?php echo $prev_antiobesity; ?>" value="<?php echo $item['anti_obesity_name']; ?>" placeholder="Add Anti-obesity" class="form-control load-drugs" /></div>
										<div class="col-lg-2"><input type="text" name="obesity_value_<?php echo $prev_antiobesity; ?>" value="<?php echo $item['anti_obesity_dose']; ?>" placeholder="Dose" class="form-control" /></div>
										
										<div class="col-lg-3" style="padding-top: 15px;">
											<div class="inline-sc" style="width: 35%;">
											<span style="display: block;width: 50%;float: left;">খাওয়ার</span> 
											<input type="text" name="obesity_condition_time_<?php echo $prev_antiobesity; ?>" value="<?php echo $item['anti_obesity_advice_codition_time']; ?>" placeholder="" class="form-control" style="float: left;width: 45%;height: 30px;margin-top: -10px;text-align: center;"></div>
											<div class="inline-sc" style="width: 20%;">
												<select name="obesity_condition_time_type_<?php echo $prev_antiobesity; ?>" class="form-control" style="text-align: center;margin-top: -14px;">
											...
											<div class="inline-sc" style="width: 20%;">
												<select name="obesity_condition_apply_<?php echo $prev_antiobesity; ?>" class="form-control" style="text-align: center;margin-top: -14px;">
										...
										<div class="col-lg-2" style="padding-top: 15px;">
											<span style="display: block;width: 30%;float: left;">চলবে</span>
											<input type="text" name="obesity_duration_<?php echo $prev_antiobesity; ?>" value="<?php echo $item['anti_obesity_duration']; ?>" style="float: left;width: 45%;height: 30px;margin-top: -10px;text-align: center;" class="form-control">
											<div class="inline-sc" style="width: 22%;">
												<select name="obesity_duration_type_<?php echo $prev_antiobesity; ?>" class="form-control" style="text-align: center;margin-top: -15px;">
							...
							<div class="input-row-fields-5" style="display:<?php echo (count($prev_others_array) !== 0)? 'block' : 'none'; ?>">
								<div id="othersFields">
									<?php 
										...
										foreach($prev_medication_others as $item):
									?>
									<div class="row-field prev-other-row">
										<div class="col-lg-3"><input type="text" name="other_name_<?php echo $prev_others; ?>" value="<?php echo $item['other_name']; ?>" placeholder="Add Others" class="form-control load-drugs" /></div>
										<div class="col-lg-2"><input type="text" name="other_value_<?php echo $prev_others; ?>" value="<?php echo $item['other_advice_codition_time']; ?>" placeholder="Dose" class="form-control" /></div>
										
										<div class="col-lg-3" style="padding-top: 15px;">
											<div class="inline-sc" style="width: 35%;">
											<span style="display: block;width: 50%;float: left;">খাওয়ার</span> 
											<input type="text" name="other_condition_time_<?php echo $prev_others; ?>" value="<?php echo $item['other_advice_codition_time']; ?>" placeholder="" class="form-control" style="float: left;width: 45%;height: 30px;margin-top: -10px;text-align: center;"></div>
											<div class="inline-sc" style="width: 20%;">
												<select name="other_condition_time_type_<?php echo $prev_others; ?>" class="form-control" style="text-align: center;margin-top: -14px;">
											...
											<div class="inline-sc" style="width: 20%;">
												<select name="other_condition_apply_<?php echo $prev_others; ?>" class="form-control" style="text-align: center;margin-top: -14px;">
										...
										<div class="col-lg-2" style="padding-top: 15px;">
											<span style="display: block;width: 30%;float: left;">চলবে</span>
											<input type="text" name="other_duration_<?php echo $prev_others; ?>" value="<?php echo $item['other_duration']; ?>" style="float: left;width: 45%;height: 30px;margin-top: -10px;text-align: center;" class="form-control">
											<div class="inline-sc" style="width: 22%;">
												<select name="other_duration_type_<?php echo $prev_others; ?>" class="form-control" style="text-align: center;margin-top: -15px;">
										...
										<div class="col-lg-1"><span class="other-add-more-htn add-more-bttn" style="cursor:pointer"><i class="mdi mdi-plus"></i> Add More</span></div>
										<?php else: ?>
										<div class="col-lg-1"><span style="cursor:pointer" class="htn-remove-htn"><i class="mdi mdi-delete"></i> Remove</span></div>
										<?php endif; ?>
						...
						<div class="row" style="margin-top:30px;">
								...
								<div class="form-group">
									...
									<div class="col-md-7">
										...
										<select name="drughistory_fdiagnosis" class="form-control">
											...
											<option value="<?php echo $key; ?>" <?php echo ($visit_drug_history_infos['drughistory_fdiagnosis'] == $key)? 'selected' : null; ?>><?php echo $key; ?></option>
											<?php endforeach; ?>
										</select>
									</div>
								</div>
							...
							<div class="col-lg-6">
								<div class="form-group">
									...
									<div class="col-md-7">
										<textarea name="drughistory_other_associated_diseases" class="check-alphanumeric-charactars" cols="30" rows="3" placeholder="Please enter" style="width:100%"><?php echo $visit_drug_history_infos['drughistory_other_associated_diseases']; ?></textarea>
									</div>
								</div>
							</div>
						</div>
			...
			<?php 
				//DB query items
				$visit_final_treatment_infos = $this->Visit_model->get_visit_final_treatment_info($visit_id); 
			?>
								...
								<div id="crntOads">
									...
									<div class="row-field current-oads-row">
										...
										<div class="col-lg-3" style="padding-top: 15px;">
											<div class="inline-sc" style="width: 35%;">
											<span style="display: block;width: 50%;float: left;">খাওয়ার</span> 
											<input type="text" value="<?php echo $item['oads_advice_codition_time']; ?>" name="crnt_oads_condition_time_1" placeholder="" class="form-control" style="float: left;width: 45%;height: 30px;margin-top: -10px;text-align: center;">
											</div>
											<div class="inline-sc" style="width: 20%;">
						...
						<div class="row" style="margin-top:30px;">
							<div class="col-lg-5">
								<div class="form-group">
									...
									<div class="col-md-5">
										<input type="text" name="finaltreat_next_visit_date" value="<?php echo ($visit_final_treatment_infos['finaltreat_next_visit_date'])? $visit_final_treatment_infos['finaltreat_next_visit_date']: null; ?>" placeholder="DD/MM/YYYY" class="form-control datepicker">
									</div>
								</div>
							</div>
							<div class="col-lg-7">
	...
	<script type="text/javascript">
		$(document).ready(function(){
			var row = $('.prev-oads-row').length+1;
			$(document).on('click', '.prev-oads-add-more-htn', function(){
				var content = '<div class="row-field prev-oads-row">' +
		...
		$(document).ready(function(){
			var row = $('.prev-insulin-row').length+1;
			$(document).on('click', '.prev-insulin-add-more-htn', function(){
				var content = '<div class="row-field prev-insulin-row">' +
		...
		$(document).ready(function(){
			var row = $('.prev-anti-htn-row').length+1;
			$(document).on('click', '.htn-add-more-htn', function(){
				var content = '<div class="row-field prev-anti-htn-row">' +
		...
		$(document).ready(function(){
			var row = $('.prev-anti-lipid-row').length+1;
			$(document).on('click', '.lipids-add-more-htn', function(){
				var content = '<div class="row-field prev-anti-lipid-row">' +
		...
		$(document).ready(function(){
			var row = $('.prev-antiplatelet-row').length+1;
			$(document).on('click', '.aspirine-add-more-htn', function(){
				var content = '<div class="row-field prev-antiplatelet-row">' +
		...
		$(document).ready(function(){
			var row = $('.prev-anti-obesity-row').length+1;
			$(document).on('click', '.obesity-add-more-htn', function(){
				var content = '<div class="row-field prev-anti-obesity-row">' +
		...
		$(document).ready(function(){
			var row = $('.prev-other-row').length+1;
			$(document).on('click', '.other-add-more-htn', function(){
				var content = '<div class="row-field prev-other-row">' +
			...
			$(document).on('click', '.submit-type', function(){
				...
				$("#createForm").validate({
					...
					submitHandler : function () {
						...
						$.ajax({
							type : "POST",
							url : baseUrl + "patients/visit/update_v_2",
