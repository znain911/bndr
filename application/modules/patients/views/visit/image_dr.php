<?php require_once APPPATH.'modules/common/header.php' ?>
	...
	<div class="row bg-title">
		...
		<div class="col-lg-9 col-sm-12 col-md-12 col-xs-12">
			...
			<input type="submit" value="Scan QR Code" onclick="myFunction()" data-toggle="modal" data-target=".scan"  id = "" class = 'laptop qr-gn-scan'  style = '    background-color: #3c4451;color: white;    margin-left: 1%;'>
		...
		<form method="post" id = 'upload_image' enctype = "multipart/form-data">
			...
			<div class="container"  style = "    background-color: #7ea2a2;box-shadow: 0 -2px 7px rgb(5 29 103 / 70%);    margin-bottom: 10%;padding-bottom: 2%;">
				<div class="row">
					...
					<div class="col-sm-12">
						<input class="col-sm-12" type="file" accept=".jpg,.jpeg"  name="image2" id= "image_file2" />
					</div>
					...
					<div class="col-sm-12">
						<input class="col-sm-12" type="file" accept=".jpg,.jpeg"  name="image4" id= "image_file4" />
					</div>
					...
					<div class="col-sm-12">
						<input class="col-sm-12" type="file" accept=".jpg,.jpeg"  name="image6" id= "image_file6" />
					</div>
					...
					<div class="col-sm-12">
						<input class="col-sm-12" type="file" accept=".jpg,.jpeg"  name="image7" id= "image_file7" />
					</div>
					...
					<div class="col-sm-12">
						<input class="col-sm-12" type="file" accept=".jpg,.jpeg"  name="image8" id= "image_file8" />
					</div>
					<?php elseif($this->session->userdata('user_type') === 'Foot Doctor'):?>
					<div class="col-sm-12" style="    margin-top: 2%;">
						<h3 class="col-sm-12" style = 'font-weight: bold;' >Foot Examination<span style="color:#f00">*</span></h3>
					</div>
					<div class="col-sm-12">
						<input class="col-sm-12" type="file" accept=".jpg,.jpeg"  name="image3" id= "image_file3" />
					</div>
					<?php elseif($this->session->userdata('user_type') === 'Eye Doctor'):?>
					<div class="col-sm-12" style="    margin-top: 2%;" >
						<h3 class="col-sm-12" style = 'font-weight: bold;' >Eye Examination<span style="color:#f00">*</span></h3>
					</div>
					<div class="col-sm-12">
						<input class="col-sm-12" type="file" accept=".jpg,.jpeg" name="image5" id= "image_file5" />
					</div>
					<?php endif;?>
	...
	$(document).ready(function(){
		$('#upload_image').on('submit', function(e){  
		   ...
		   <?php if($this->session->userdata('user_type') === 'Foot Doctor'): ?>
		    if($('#image_file3').val() == '') 
				{  
				alert("Please Select a File for Foot Examination");  
			<?php elseif($this->session->userdata('user_type') === 'Eye Doctor'): ?>
				if($('#image_file5').val() == '') 
				{  
				alert("Please Select a File for Eye Examination");  
				<?php else:?>
		   if($('#image_file1').val() == '') 
			   {  
				alert("Please Select a File for Personal Info,Family History & Glucose Intolerance"); 
			<?php endif; ?>			   
