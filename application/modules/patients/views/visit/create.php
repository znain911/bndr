<?php require_once APPPATH.'modules/common/header.php' ?>
	...
	<div class="row bg-title">
		...
		<input type="submit" value="Scan QR Code" onclick="myFunction()" data-toggle="modal" data-target=".scan"  style = 'background-color: #3c4451;color: white;    margin-left: 1%;'>
			...
			<div class="modal-dialog modal-sm" style = "margin: 0px;    height: 100%;">
				<div class="modal-content" style = "height: 100%;">
					<div class="modal-header">
						<h4 class="modal-title" id="mySmallModalLabel" style="font-size: 30px;font-weight: bold;text-align: center;width: 50%;">QR Code Scanner</h4> 
					</div>
					<div class="modal-body " style = "padding: 0px;" id ="scanner">
						
					</div>
					<div class="modal-footer" style = "text-align: center;margin-right: 50%;">
	...
	<div class="col-lg-12">
			<strong>Image : </strong> &nbsp;&nbsp;<label class="pres-controler" data-value="1"><input type="radio" name="crnt_is_insulin" value="1" />&nbsp; Yes</label> &nbsp;&nbsp; <label class="pres-controler" data-value="0"><input type="radio" name="crnt_is_insulin" value="0" checked />&nbsp; No</label>
	</div>
									...
									<div class="row-field drug-history-oads">
										...
										<div class="col-lg-3" style="padding-top: 15px;">
											<div class="inline-sc" style="width: 35%;">
												...
												<input type="text" name="oads_condition_time_1" placeholder="" class="form-control" style="float: left;width: 45%;height: 30px;margin-top: -10px;text-align: center;">
											</div>
								...
								<div id="crntOads">
									<div class="row-field">
										...
										<div class="col-lg-3" style="padding-top: 15px;">
											<div class="inline-sc" style="width: 35%;">
												<span style="display: block;width: 50%;float: left;">খাওয়ার</span> 
												<input type="text" name="crnt_oads_condition_time_1" placeholder="" class="form-control" style="float: left;width: 45%;height: 30px;margin-top: -10px;text-align: center;">
											</div>
											<div class="inline-sc" style="width: 20%;">
	...
	<div style = 'display : none;' id = 'imageControler'>
			...
			$(".qr-gn").click(function(){
			 //alert('hello');
				...
				$.ajax({
				  ...
				  //document.location.href = baseUrl+'patients/visit/add/'+<?php echo $patient_id;?>+'/'+bndrId;
			});
