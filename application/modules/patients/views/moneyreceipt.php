				...
				<div class="row">
					<div class="receipt-header receipt-header-mid">
						<div class="col-xs-12 col-sm-12 col-md-12 text-center prnt-body">
							...
							<p><strong><?php echo $receipt['org_name']; ?></strong></p>
						</div>
					</div>
				</div>
					...
					<table class="table table-bordered">
						<tbody>
							...
							<tr>
								...
								<td class="col-md-3">Electronic Registration Fee</td>
							</tr>
							<tr>
								<td class="text-right">
									<p>
								...
								<td>
									<p>
										<strong><i class="fa fa-inr"></i> <?php echo $receipt['patient_regfee_amount']; ?>/-</strong>
									</p>
								</td>
							</tr>
							<tr>
								...
								<td class="text-left text-danger"><h2><strong><i class="fa fa-inr"></i> <?php echo $receipt['patient_regfee_amount']; ?>/-</strong></h2></td>
							</tr>
						</tbody>
					</table>
				</div>
						...
						<div class="col-xs-8 col-sm-8 col-md-8 text-left">
							<div class="receipt-right">
								...
								<p><b>Payment Status :</b> 
									<?php if($receipt['patient_payment_status'] == '1'): ?>
