			...
			<div class ="row" >
				...
				<div class="col-sm-4" id ="nst" >
					<ul class="nav" id="side-menu ">
						...
						<li  class="dhp dhpm"><span style = "cursor: pointer;" class="check-save" onclick="window.location.href='<?php echo base_url('patients/visit/all/'.$patient_id.'/'.$patient_entry_id); ?>'">Cancel</span></li>
			...
			<div class="modal-dialog modal-sm">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<span class="btn btn-default waves-effect" data-dismiss="modal">Cancel</span>
						<button type="submit" class="btn btn-info confirm-payment submit-type" data-save-method="save">Confirm</button>
					</div>
				</div>
			</div>
		</div>
				...
				<div class = "row " style="background: #FFFFFF; padding-bottom: 10px;border-radius: 10px;margin: auto;">
					...
					<div class = "col-sm-12 padding" style= 'height: 110px'>
						...
						<div class="col-sm-11" >
							...
							<textarea  class="" cols="30" rows="3"  style="width:100%;font-size: 20px;" readonly><?php echo $patientinfo['patient_address']; ?></textarea>
						</div>
...
  							<label for="Others">Others</label><br>
						...
						<div  id ="left" class = "col-sm-4 padding" >
							...
							<div  class = "col-sm-12 padding p" style= 'height: 50px'>
								<div  class = "col-sm-6 padding"  >
									<input type="radio" id="Foot" name="type_of_glucose" value="Type2DM" <?php if($glucose){ echo $glucose['dhistory_type_of_glucose'] === 'Type2DM'? 'checked': null;} ?>>
	  								<label >Type2DM</label><br>
								</div>
								<div  class = "col-sm-6 padding"  >
									<input type="radio" id="Foot" name="type_of_glucose" value="Type1DM" <?php if($glucose){ echo $glucose['dhistory_type_of_glucose'] === 'Type1DM'? 'checked': null; }?>>
	  								<label >Type1DM</label><br>
								</div>
							</div>
							<div  class = "col-sm-12 padding p" style= 'height: 50px'>
								<div  class = "col-sm-6 padding" >
									<input type="radio" id="Foot" name="type_of_glucose" value="IGT" <?php if($glucose){ echo $glucose['dhistory_type_of_glucose'] === 'IGT'? 'checked': null; }?>>
	  								<label >IGT</label><br>
								</div>
								<div  class = "col-sm-6 padding" >
									<input type="radio" id="Foot" name="type_of_glucose" value="IFG" <?php if($glucose){ echo $glucose['dhistory_type_of_glucose'] === 'IFG'? 'checked': null; }?>>
	  								<label >IFG</label><br>
								</div>
							</div>
							<div  class = "col-sm-12 padding p" style= 'height: 50px'>
								<div  class = "col-sm-6 padding " >
									<input type="radio" id="Foot" name="type_of_glucose" value="GDM" <?php if($glucose){ echo $glucose['dhistory_type_of_glucose'] === 'GDM'? 'checked': null; }?>>
	  								<label >GDM</label><br>
								</div>
								<div  class = "col-sm-6 padding" >
									<input type="radio" id="Foot" name="type_of_glucose" value="Others" <?php if($glucose){ echo $glucose['dhistory_type_of_glucose'] === 'Others'? 'checked': null;} ?>>
	  								<label >Others</label><br>
							...
							<div  class = "col-sm-12 padding p"  style= 'height: 50px'>
								<div  class = "col-sm-6 padding " >
									...
									<?php if($glucose){
										if($glucose['dhistory_prev_bad_obstetric_history'] === 'YES'){
											echo 'checked';
										}
									}?>>
	  								<label >YES</label><br>
								...
								<div  class = "col-sm-6 padding" >
									...
									<?php if($glucose){
										if($glucose['dhistory_prev_bad_obstetric_history'] === 'NO'){
											echo 'checked';
										}
									}?>>
	  								<label >NO</label><br>
							...
							<div  class = "col-sm-12 padding p" style= 'height: 50px'>
								<div  class = "col-sm-6 padding " >
									...
									<?php if($glucose){
										if($glucose['dhistory_prev_history_of_gdm'] === 'YES'){
											echo 'checked';
										}
									}?>>
	  								<label >YES</label><br>
								...
								<div  class = "col-sm-6 padding" >
									...
									<?php if($glucose){
										if($glucose['dhistory_prev_history_of_gdm'] === 'NO'){
											echo 'checked';
										}
									}?>>
	  								<label >NO</label><br>
							...
							<div  class = "col-sm-12 padding p" >
								...
								<textarea   class="" cols="30" rows="5"  style="width:100%;font-size: 20px;" ><?php 
								if ($glucose):
								echo $glucose['dhistory_past_medical_history']; 
								endif;
								?></textarea>
						...
						<div   class = "col-sm-8 padding" id ="right" style="width: 69%;" >
							...
							<div   class = "col-sm-12 padding p" style="height: 130px">
								...
								<div class="col-sm-9 padding p">
									<textarea name="added_clinical_info" class="check-alphanumeric-charactars" cols="30" rows="3" placeholder="Insert Additonal info" style="width:100%;height: 80px;font-size: 20px;"><?php echo $investigation? $investigation['finaltreat_clinical_info']: null ; ?></textarea>
								</div>
							</div>
							<div   class = "col-sm-12 padding p" style="height: 180px">
								...
								<div class="col-sm-9 padding p">
									<textarea name="finaltreat_dietary_advice" class="check-alphanumeric-charactars" cols="30" rows="3" placeholder="Insert Advice Here" style="width:100%;height: 150px;font-size: 20px;"><?php echo $investigation? $investigation['finaltreat_dietary_advice']: null ; ?></textarea>
								</div>
							</div>
							...
							<div   class = "col-sm-12 padding p" style="height: 180px">
								...
								<div class="col-sm-9 padding p">
									<textarea name="finaltreat_physical_acitvity" class="check-alphanumeric-charactars" cols="30" rows="3" placeholder="Insert Physical Acitvity" style="width:100%;height: 150px;font-size: 20px;"><?php echo $investigation? $investigation['finaltreat_physical_acitvity']: null ; ?></textarea>
								</div>
							</div>
							<div   class = "col-sm-12 padding p" style="height: 180px">
								...
								<div class="col-sm-9 padding p">
									<textarea name="finaltreat_other_advice" class="check-alphanumeric-charactars" cols="30" rows="3" placeholder="Insert Additional advice" style="width:100%;height: 150px;font-size: 20px;"><?php echo $investigation? $investigation['finaltreat_other_advice']: null ; ?></textarea>
								</div>
							</div>
							<div   class = "col-sm-12 padding p" style="height: 130px">
								<label class="control-label col-sm-3 padding p">Diet No</label>
								<div class="col-sm-9 padding p">
									<input type="text" class = "finaltreat_diet_no" value="<?php echo $investigation? $investigation['finaltreat_diet_no']: null ; ?>" name="finaltreat_diet_no" style="width:100%;height: 80px;font-size: 20px;" class="" />
								</div>
							</div>
							<div   class = "col-sm-12 padding p" id= "page_no" style="height: 120px">
								<label class="control-label col-sm-3 padding p">Page No</label>
									<div class="col-sm-9 padding p">
										<input type="text" class = "finaltreat_diet_no" value="<?php echo $investigation? $investigation['finaltreat_page_no']: null ; ?>" name="finaltreat_page_no" style="width:100%;height: 80px;font-size: 20px;" class="" />
									</div>
							</div>
							...
							<div class = "col-sm-12 padding input-row-fields-9-cntr" style="display: block;" >
								...
								<div style = "box-shadow: 0px 0px 4px rgb(0 0 0 / 70%);margin-top:2%"  class = "col-sm-12 padding"  >
									
										<div class="col-sm-12" style= "margin-top: 20px;height: 70px;">
											<label class="col-sm-2 padding p"> OADs: </label>
											<input type="text" name="crnt_oads_name_<?php echo $med_count;?>" value= "<?php echo $oad['oads_name'];?>" style = 'height: 65px;font-size: 20px;' placeholder="Add OADs" class=" load-drugs col-sm-10 padding p" />
										</div>
										<div class="col-sm-12" style = 'height: 70px;'>
											<label class="col-sm-2 padding p"> Dose: </label>
											<input type="text" name="crnt_oads_value_<?php echo $med_count;?>" value='<?php echo $oad['oads_dose'];?>' style = 'height: 65px;font-size: 20px;'  placeholder="ADD Dose" class="col-sm-10 padding p" />
										</div>
									...
									<div style= "padding-top: 20px;"  class = "col-sm-12 padding" >
										<div class="col-sm-4 padding">
											<div class="inline-sc" style="width: 100%;">
												...
												<input type="text" name="crnt_oads_condition_time_<?php echo $med_count;?>" value='<?php if($oad['oads_advice_codition_time']){ echo $oad['oads_advice_codition_time'];}?>' placeholder="" class="" style="float: left;width: 42%;text-align: center;font-size: 20px;margin-top: 0px;">
											</div>
											
										</div>
										<div class="col-sm-4 padding">
											<div class="inline-sc" style="width: 100%;">
												<select name="crnt_oads_condition_time_type_<?php echo $med_count;?>" class="form-control" style="text-align: center;margin-top: -4px;width: 48%;display: inline-block;font-size: 20px;">
													<option value="মিনিট" <?php if($oad['oads_advice_codition_time_type'] === 'মিনিট'){ echo 'selected';}?>>মিনিট</option>
													<option value="ঘন্টা" <?php if($oad['oads_advice_codition_time_type'] === 'ঘন্টা'){ echo 'selected';}?>>ঘন্টা</option>
												</select>
												<select name="crnt_oads_condition_apply_<?php echo $med_count;?>" class="form-control" style="text-align: center;margin-top: -4px;width: 48%;display: inline-block;font-size: 20px;">
													<option value="আগে" <?php if($oad['oads_advice_codition_apply'] === 'আগে'){ echo 'selected';}?>>আগে</option>
													<option value="মাঝে" <?php if($oad['oads_advice_codition_apply'] === 'মাঝে'){ echo 'selected';}?>>মাঝে</option>
													<option value="পরে" <?php if($oad['oads_advice_codition_apply'] === 'পরে'){ echo 'selected';}?>>পরে</option>
												</select>
											</div>
										</div>
										<div class="col-sm-4 padding">
											<span style="display: block;width: 32%;float: left;font-size: 20px;">চলবে</span>
												<input type="text" name="crnt_oads_duration_<?php echo $med_count;?>" value='<?php if($oad['oads_duration']){ echo $oad['oads_duration'];}?>' style="float: left;width: 40%;text-align: center;font-size: 20px;" class="">
												<div class="inline-sc" style="width: 22%;">
													<select name="crnt_oads_duration_type_<?php echo $med_count;?>" class="form-control" style="text-align: center;margin-top: -4px;font-size: 20px;">
														<option value="দিন"  <?php if($oad['oads_duration_type'] === 'দিন'){ echo 'selected';}?> >দিন</option>
														<option value="মাস" <?php if($oad['oads_duration_type'] === 'মাস'){ echo 'selected';}?> >মাস</option>
													</select>
												</div>
										</div>
										
										<input type="hidden" name="crnt_oads_row[]" value="<?php echo $med_count;?>" />
									...
									<?php else:?>
									<div style ="padding-bottom: 10px;" class="col-sm-1"><span class="htn-remove-htn" style="cursor:pointer;    background: #fff none repeat scroll 0 0;"><i class="mdi mdi-delete">
										</i></span>
									</div>
									<?php endif;?>
								</div>
							...
							<div class = "col-sm-12 padding input-row-fields-10-cntr p" style="display: none;" >
								...
								$day_count2 = 1;
								$day_count3 = 1;
								foreach($insuline as $insulines):?>
								<div style = "box-shadow: 0px 0px 4px rgb(0 0 0 / 70%);"  class = "col-sm-12 padding"  >
									
										<div class="col-sm-12" style= "margin-top: 20px;height: 70px;">
											<label class="col-sm-2 padding p" > Insulin: </label>
											<input type="text" style = "height: 65px;font-size: 20px;" value= "<?php echo $insulines['insulin_name'];?>" name="crnt_insulin_name_<?php echo $med_count;?>" placeholder="Add Insulin" class=" load-drugs-insulin col-sm-10 padding p" />
										</div>
										<div class="col-sm-12" style = "height: 70px;">
											<label class="col-sm-2 padding p"> Dose: </label>
											<input type="text"  style = "height: 65px;font-size: 20px;" value= "<?php echo $insulines['insulin_dose'];?>" name="crnt_insulin_value_<?php echo $med_count;?>" placeholder="ADD Dose" class="col-sm-10 padding p" />
										</div>
											
									
									
									<div style= "padding-top: 20px;<?php if($insulines['insulin_before_sleep'] === '1' ||$insulines['insulin_week_days']){ echo 'display: none;';}?>"  class = "col-sm-12 padding p" >
										<div class="col-sm-8 padding">
											<div class="inline-sc" style="width: 40%;">
												<span style="display: block;width: 55%;float: left;font-size: 20px;">খাওয়ার</span> 
												<input type="text" value= "<?php echo $insulines['insulin_advice_codition_time'];?>" name="crnt_insulin_condition_time_<?php echo $med_count;?>" placeholder="" class="" style="float: left;width: 42%;font-size: 20px;margin-top: -4px;margin-left: 2%;text-align: center;">
											</div>
											<div class="inline-sc" style="width: 25%;">
												<select name="crnt_insulin_condition_time_type_<?php echo $med_count;?>" class="form-control" style="text-align: center;margin-top: -4px;font-size: 20px;">
													<option value="মিনিট" <?php if($insulines['insulin_advice_codition_time_type'] === 'মিনিট'){ echo 'selected';}?> >মিনিট</option>
													<option value="ঘন্টা" <?php if($insulines['insulin_advice_codition_time_type'] === 'ঘন্টা'){ echo 'selected';}?> >ঘন্টা</option>
												</select>
											</div>
											<div class="inline-sc" style="width: 25%;">
												<select name="crnt_insulin_condition_apply_<?php echo $med_count;?>" class="form-control" style="text-align: center;margin-top: -4px;font-size: 20px;">
													<option value="আগে" <?php if($insulines['insulin_advice_codition_apply'] === 'আগে'){ echo 'selected';}?> >আগে</option>
													<option value="পরে" <?php if($insulines['insulin_advice_codition_apply'] === 'পরে'){ echo 'selected';}?>  >পরে</option>
												</select>
											</div>
										</div>
										<div class="col-sm-4 padding">
											<span style="display: block;width: 32%;float: left;font-size: 20px;">চলবে</span>
											<input type="text" name="crnt_insulin_duration_<?php echo $med_count;?>" value= "<?php echo $insulines['insulin_duration'];?>" style="float: left;width: 40%;font-size: 20px;margin-top: -4px;text-align: center;" class="">
											<div class="inline-sc" style="width: 22%;">
												<select name="crnt_insulin_duration_type_<?php echo $med_count;?>" class="form-control" style="text-align: center;margin-top: -4px;font-size: 20px;">
													<option value="দিন" <?php if($insulines['insulin_duration_type'] === 'দিন'){ echo 'selected';}?>  >দিন</option>
													<option value="মাস" <?php if($insulines['insulin_duration_type'] === 'মাস'){ echo 'selected';}?>  >মাস</option>
												</select>
											</div>
										</div>
										
										<input type="hidden" name="crnt_insulin_row[]" value="<?php echo $med_count;?>" />
										<div style="clear:both"></div>
										
										
									</div>
									<div style= "padding-top: 20px;<?php if($insulines['insulin_week_days']){ echo 'display: none;';}?>"  class = "col-sm-12 padding p" >
										<label class="special-insulin" style ="font-size: 20px" ><input class="special-insulin-value"  type="checkbox" name="before_sleeping_<?php echo $med_count;?>" value="1" <?php if($insulines['insulin_before_sleep'] === '1'){ echo 'checked';}?>/> &nbsp;ঘুমানোর &nbsp; আগে &nbsp; চলবে</label>
									</div>
									<div style= "padding-top: 20px;<?php if($insulines['insulin_before_sleep'] === '1'){ echo 'display: none;';}?>"  class = "col-sm-12 padding p" >
										<label class="special-insulin-week" style ="font-size: 20px" ><input class="special-insulin-value-week"  type="checkbox" name="week_<?php echo $med_count;?>" value="1" <?php if($insulines['insulin_week_days']){ echo 'checked';}?> /> &nbsp; সপ্তাহে </label>
										<input type="number"  name="crnt_insulin_week_<?php echo $med_count;?>" placeholder="" class="" value = "<?php if($insulines['insulin_week_days']){ echo $insulines['insulin_week_days'];}?>" style="width: 20%;font-size: 20px;margin-top: -4px;margin-left: 2%;text-align: center;">
										<span style="display: inline-block;width: 15%;font-size: 20px;">দিন</span>
									</div>
									
									<div style= "padding-top: 20px;<?php if($insulines['insulin_week_days'] ){ echo 'display: block;';}else{echo 'display: none;';}?>"  class = "col-sm-12 padding p" >
										
										<label class="day-label" style ="font-size: 20px" ><input class=""  type="checkbox" name="day_<?php echo $med_count;?>_<?php echo $day_count2;?>" value="রবি" <?php if ( strpos($insulines['insulin_days_list'], 'রবি' )!== false){ echo 'checked';}?> /> &nbsp; রবি </label>
										<label class="day-label" style ="font-size: 20px" ><input class=""  type="checkbox" name="day_<?php $day_count2++; echo $med_count;?>_<?php echo $day_count2;?>" value="সোম" <?php if ( strpos($insulines['insulin_days_list'], 'সোম' )!== false){ echo 'checked';}?> /> &nbsp; সোম </label>
										<label class="day-label" style ="font-size: 20px" ><input class=""  type="checkbox" name="day_<?php $day_count2++; echo $med_count;?>_<?php echo $day_count2;?>" value="মঙ্গল" <?php if ( strpos($insulines['insulin_days_list'], 'মঙ্গল' )!== false){ echo 'checked';}?> /> &nbsp; মঙ্গল </label>
										<label class="day-label" style ="font-size: 20px" ><input class=""  type="checkbox" name="day_<?php $day_count2++; echo $med_count;?>_<?php echo $day_count2;?>" value="বুধ" <?php if ( strpos($insulines['insulin_days_list'], 'বুধ' )!== false){ echo 'checked';}?> /> &nbsp; বুধ</label>
										<label class="day-label" style ="font-size: 20px" ><input class=""  type="checkbox" name="day_<?php $day_count2++; echo $med_count;?>_<?php echo $day_count2;?>" value="বৃহস্পতি" <?php if ( strpos($insulines['insulin_days_list'], 'বৃহস্পতি' )!== false){ echo 'checked';}?> /> &nbsp; বৃহস্পতি</label>
										<label class="day-label" style ="font-size: 20px" ><input class=""  type="checkbox" name="day_<?php $day_count2++; echo $med_count;?>_<?php echo $day_count2;?>" value="শুক্র" <?php if ( strpos($insulines['insulin_days_list'], 'শুক্র' )!== false){ echo 'checked';}?> /> &nbsp; শুক্র</label>
										<label class="day-label" style ="font-size: 20px" ><input class=""  type="checkbox" name="day_<?php $day_count2++; echo $med_count;?>_<?php echo $day_count2;?>" value="শনি" <?php if ( strpos($insulines['insulin_days_list'], 'শনি' )!== false){ echo 'checked';}?> /> &nbsp; শনি </label>
										
										<label class="special-insulin-day" style ="font-size: 20px" ><input class="special-insulin-value-day"  type="checkbox" name="jekonodin_<?php echo $med_count;?>" value="যে কোন দিন" <?php if ( strpos($insulines['insulin_days_list'], 'যে কোন দিন' )!== false){ echo 'checked';}?> /> &nbsp; যে কোন দিন </label>
										<input type="hidden" name="day_array[]" value="<?php echo $day_count3;?>" />
										<input type="hidden" name="day_array[]" value="<?php $day_count3++; echo $day_count3;?>" />
										<input type="hidden" name="day_array[]" value="<?php $day_count3++; echo $day_count3;?>" />
										<input type="hidden" name="day_array[]" value="<?php $day_count3++; echo $day_count3;?>" />
										<input type="hidden" name="day_array[]" value="<?php $day_count3++; echo $day_count3;?>" />
										<input type="hidden" name="day_array[]" value="<?php $day_count3++; echo $day_count3;?>" />
							...
							<div class = "col-sm-12 padding input-row-fields-cntr p" style="display: none;" >
								...
								<div style = "box-shadow: 0px 0px 4px rgb(0 0 0 / 70%);"  class = "col-sm-12 padding p"  >
										...
										<div class="col-sm-12" style= "margin-top: 20px;height: 70px;">
											...
											<input type="text" style = "height: 65px;font-size: 20px;" value= "<?php echo $htns['anti_htn_name'];?>" name="crnt_anti_htn_name_<?php echo $med_count;?>" placeholder="Add Anti HTN" class="load-drugs col-sm-10 padding p" />
										</div>
										<div class="col-sm-12" style = "height: 70px;">
											<label class="col-sm-2 padding p" > Dose: </label>
											<input type="text" value= "<?php echo $htns['anti_htn_dose'];?>" style = "height: 65px;font-size: 20px;" name="crnt_anti_htn_value_<?php echo $med_count;?>" placeholder="ADD Dose" class="col-sm-10 padding p" />
										</div>
									...
									<div style= "padding-top: 20px;"  class = "col-sm-12 padding" >
										<div class="col-sm-8 padding">
											<div class="inline-sc" style="width: 40%;">
												<span style="display: block;width: 55%;float: left;font-size: 20px;">খাওয়ার</span> 
												<input type="text" name="crnt_anti_htn_condition_time_<?php echo $med_count;?>" value= "<?php echo $htns['anti_htn_advice_codition_time'];?>" placeholder="" class="" style="float: left;width: 45%;font-size: 20px;margin-top: -4px;text-align: center;">
											</div>
											<div class="inline-sc" style="width: 25%;">
												<select name="crnt_anti_htn_condition_time_type_<?php echo $med_count;?>" class="form-control" style="text-align: center;margin-top: -4px;font-size: 20px;">
													<option value="মিনিট" <?php if($htns['anti_htn_advice_codition_time_type'] === 'মিনিট'){ echo 'selected';}?>  >মিনিট</option>
													<option value="ঘন্টা" <?php if($htns['anti_htn_advice_codition_time_type'] === 'ঘন্টা'){ echo 'selected';}?> >ঘন্টা</option>
												</select>
											</div>
											<div class="inline-sc" style="width: 25%;">
												<select name="crnt_anti_htn_condition_apply_<?php echo $med_count;?>" class="form-control" style="text-align: center;margin-top: -4px;font-size: 20px;">
													<option value="আগে" <?php if($htns['anti_htn_advice_codition_apply'] === 'আগে'){ echo 'selected';}?>>আগে</option>
													<option value="পরে" <?php if($htns['anti_htn_advice_codition_apply'] === "পরে"){ echo 'selected';}?> >পরে</option>
												</select>
											</div>
										</div>
										<div class="col-sm-4 padding">
											<span style="display: block;width: 32%;float: left;font-size: 20px;">চলবে</span>
											<input type="text" name="crnt_anti_htn_duration_<?php echo $med_count;?>" value= "<?php echo $htns['anti_htn_duration'];?>" style="float: left;width: 40%;font-size: 20px;margin-top: -4px;text-align: center;" class="">
											<div class="inline-sc" style="width: 22%;">
												<select name="crnt_anti_htn_duration_type_<?php echo $med_count;?>" class="form-control" style="text-align: center;margin-top: -4px;font-size: 20px;">
													<option value="দিন" <?php if($htns['anti_htn_duration_type'] === 'দিন'){ echo 'selected';}?> >দিন</option>
													<option value="মাস" <?php if($htns['anti_htn_duration_type'] === 'মাস'){ echo 'selected';}?> >মাস</option>
												</select>
											</div>
										</div>
										
										<input type="hidden" name="crnt_anti_htn_row[]" value="<?php echo $med_count;?>" />
										<div style="clear:both"></div>
									</div>
									<?php if($htn_count === 1):?>
									<div style="padding-bottom: 10px" class="col-sm-3">
							...
							<div class = "col-sm-12 padding input-row-fields-2-cntr p" style="display: none;" >
								...
								if ($lipid):
								$lipid_count = 1;
								foreach($lipid as $lipids):?>
								<div style = "box-shadow: 0px 0px 4px rgb(0 0 0 / 70%);"  class = "col-sm-12 padding p"  >
									
										<div class="col-sm-12" style= "margin-top: 20px;height: 70px;">
											<label class="col-sm-2 padding p"> Anti-lipid: </label>
											<input type="text" style = "height: 65px;font-size: 20px;" value= "<?php echo $lipids['anti_lipid_name'];?>" name="crnt_lipids_name_<?php echo $med_count;?>" placeholder="Add Anti Lipids" class="load-drugs col-sm-10 padding p" />
										</div>
										<div class="col-sm-12" style = "height: 70px;">
											<label class="col-sm-2 padding p"> Dose: </label>
											<input type="text" value= "<?php echo $lipids['anti_lipid_dose'];?>" style = "height: 65px;font-size: 20px;" name="crnt_lipids_value_<?php echo $med_count;?>" placeholder="ADD Dose" class="col-sm-10 padding p" />
										</div>
									...
									<div style= "padding-top: 20px;"  class = "col-sm-12 padding p" >
										<div class="col-sm-8 padding">
											<div class="inline-sc" style="width: 40%;">
												<span style="display: block;width: 55%;float: left;font-size: 20px;">খাওয়ার</span> 
												<input type="text"  value= "<?php echo $lipids['anti_lipid_advice_codition_time'];?>" name="crnt_lipids_condition_time_<?php echo $med_count;?>" placeholder="" class="" style="float: left;width: 45%;font-size: 20px;margin-top: -4px;text-align: center;">
											</div>
											<div class="inline-sc" style="width: 25%;">
												<select name="crnt_lipids_condition_time_type_<?php echo $med_count;?>" class="form-control" style="text-align: center;margin-top: -4px;font-size: 20px;">
													<option value="মিনিট" <?php if($lipids['anti_lipid_advice_codition_time_type'] === 'মিনিট'){ echo 'selected';}?> >মিনিট</option>
													<option value="ঘন্টা" <?php if($lipids['anti_lipid_advice_codition_time_type'] === 'ঘন্টা'){ echo 'selected';}?> >ঘন্টা</option>
												</select>
											</div>
											<div class="inline-sc" style="width: 25%;">
												<select name="crnt_lipids_condition_apply_<?php echo $med_count;?>" class="form-control" style="text-align: center;margin-top: -4px;font-size: 20px;">
													<option value="আগে" <?php if($lipids['anti_lipid_advice_codition_apply'] === 'আগে'){ echo 'selected';}?> >আগে</option>
													<option value="পরে" <?php if($lipids['anti_lipid_advice_codition_apply'] === 'পরে'){ echo 'selected';}?> >পরে</option>
												</select>
											</div>
										</div>
										<div class="col-sm-4 padding">
											<span style="display: block;width: 32%;float: left;font-size: 20px;">চলবে</span>
											<input type="text" value= "<?php echo $lipids['anti_lipid_duration'];?>" name="crnt_lipids_duration_<?php echo $med_count;?>" style="float: left;width: 40%;font-size: 20px;margin-top: -4px;text-align: center;" class="">
											<div class="inline-sc" style="width: 22%;">
												<select name="crnt_lipids_duration_type_<?php echo $med_count;?>" class="form-control" style="text-align: center;margin-top: -4px;font-size: 20px;">
													<option value="দিন" <?php if($lipids['anti_lipid_duration_type'] === 'দিন'){ echo 'selected';}?>  >দিন</option>
													<option value="মাস" <?php if($lipids['anti_lipid_duration_type'] === 'মাস'){ echo 'selected';}?>  >মাস</option>
												</select>
											</div>
										</div>
										
										<input type="hidden" name="crnt_lipids_row[]" value="<?php echo $med_count;?>" />
										<div style="clear:both"></div>
									</div>
									<?php if($lipid_count === 1):?>
									<div style="padding-bottom: 10px" class="col-sm-3">
							...
							<div class = "col-sm-12 padding input-row-fields-3-cntr p" style="display: none;" >
								...
								if ($antiplatelet):
								$lipid_count = 1;
								foreach($antiplatelet as $antiplatelets):?>
								<div style = "box-shadow: 0px 0px 4px rgb(0 0 0 / 70%);"  class = "col-sm-12 padding p"  >
									
										<div class="col-sm-12" style= "margin-top: 20px;height: 70px;">
											<label class="col-sm-3 padding p"> Anti-platelet: </label>
											<input type="text" value= "<?php echo $antiplatelets['antiplatelets_name'];?>" style = "height: 65px;font-size: 20px;" name="crnt_aspirine_name_<?php echo $med_count;?>" placeholder="Add Anti Platelet" class="load-drugs col-sm-9 padding p" />
										</div>
										<div class="col-sm-12 " style = "height: 70px;">
											<label class="col-sm-3 padding p"> Dose: </label>
											<input type="text" value= "<?php echo $antiplatelets['antiplatelets_dose'];?>" style = "height: 65px;font-size: 20px;" name="crnt_aspirine_value_<?php echo $med_count;?>" placeholder="ADD Dose" class="col-sm-9 padding p" />
										</div>
									...
									<div style= "padding-top: 20px;"  class = "col-sm-12 padding" >
										<div class="col-sm-8 padding p">
											<div class="inline-sc" style="width: 40%;">
												<span style="display: block;width: 55%;float: left;font-size: 20px;">খাওয়ার</span> 
												<input type="text" value= "<?php echo $antiplatelets['antiplatelets_advice_codition_time'];?>" name="crnt_aspirine_condition_time_<?php echo $med_count;?>" placeholder="" class="" style="float: left;width: 45%;font-size: 20px;margin-top: -4px;text-align: center;">
											</div>
											<div class="inline-sc" style="width: 25%;">
												<select name="crnt_aspirine_condition_time_type_<?php echo $med_count;?>" class="form-control" style="text-align: center;margin-top: -4px;font-size: 20px;">
													<option value="মিনিট" <?php if($antiplatelets['antiplatelets_advice_codition_time_type'] === 'মাস'){ echo 'selected';}?> >মিনিট</option>
													<option value="ঘন্টা" <?php if($antiplatelets['antiplatelets_advice_codition_time_type'] === 'ঘন্টা'){ echo 'selected';}?>  >ঘন্টা</option>
												</select>
											</div>
											<div class="inline-sc" style="width: 25%;">
												<select name="crnt_aspirine_condition_apply_<?php echo $med_count;?>" class="form-control" style="text-align: center;margin-top: -4px;font-size: 20px;">
													<option value="আগে" <?php if($antiplatelets['antiplatelets_advice_codition_apply'] === 'আগে'){ echo 'selected';}?>>আগে</option>
													<option value="পরে" <?php if($antiplatelets['antiplatelets_advice_codition_apply'] === 'পরে'){ echo 'selected';}?> >পরে</option>
												</select>
											</div>
										</div>
										<div class="col-sm-4 padding">
											<span style="display: block;width: 32%;float: left;font-size: 20px;">চলবে</span>
											<input type="text" value= "<?php echo $antiplatelets['antiplatelets_duration'];?>" name="crnt_aspirine_duration_<?php echo $med_count;?>" style="float: left;width: 40%;font-size: 20px;margin-top: -4px;text-align: center;" class="">
											<div class="inline-sc" style="width: 22%;">
												<select name="crnt_aspirine_duration_type_<?php echo $med_count;?>" class="form-control" style="text-align: center;margin-top: -4px;font-size: 20px;">
													<option value="দিন" <?php if($antiplatelets['antiplatelets_duration_type'] === 'দিন'){ echo 'selected';}?> >দিন</option>
													<option value="মাস" <?php if($antiplatelets['antiplatelets_duration_type'] === 'মাস'){ echo 'selected';}?> >মাস</option>
												</select>
											</div>
										</div>
										
										<input type="hidden" name="crnt_aspirine_row[]" value="<?php echo $med_count;?>" />
										<div style="clear:both"></div>
									</div>
									<?php if($lipid_count === 1):?>
									<div style="padding-bottom: 10px" class="col-sm-3">
							...
							<div class = "col-sm-12 padding input-row-fields-4-cntr" style="display: none;" >
								...
								if ($obesity):
								$obesity_count = 1;
								foreach($obesity as $obesitys):?>
								<div style = "box-shadow: 0px 0px 4px rgb(0 0 0 / 70%);"  class = "col-sm-12 padding p"  >
									
										<div class="col-sm-12" style= "margin-top: 20px;height: 70px;">
											<label class="col-sm-3 padding p"> Anti-obesity: </label>
											<input type="text" value= "<?php echo $obesitys['anti_obesity_name'];?>" style = "height: 65px;font-size: 20px;" name="crnt_obesity_name_<?php echo $med_count;?>" placeholder="Add Anti Obesity" class="load-drugs col-sm-9 padding p" />
										</div>
										<div class="col-sm-12 " style = "height: 70px;" >
											<label class="col-sm-3 padding p"> Dose: </label>
											<input type="text" value= "<?php echo $obesitys['anti_obesity_dose'];?>" style = "height: 65px;font-size: 20px;" name="crnt_obesity_value_<?php echo $med_count;?>" placeholder="ADD Dose" class="col-sm-9 padding p" />
										</div>
									...
									<div style= "padding-top: 20px;"  class = "col-sm-12 padding p" >
										<div class="col-sm-8 padding p">
											<div class="inline-sc" style="width: 40%;">
												<span style="display: block;width: 55%;float: left;font-size: 20px;">খাওয়ার</span> 
												<input type="text" value= "<?php echo $obesitys['anti_obesity_advice_codition_time'];?>" name="crnt_obesity_condition_time_<?php echo $med_count;?>" placeholder="" class="" style="float: left;width: 45%;font-size: 20px;margin-top: -4px;text-align: center;">
											</div>
											<div class="inline-sc" style="width: 25%;">
												<select name="crnt_obesity_condition_time_type_<?php echo $med_count;?>" class="form-control" style="text-align: center;margin-top: -4px;font-size: 20px;">
													<option value="মিনিট"  <?php if($obesitys['anti_obesity_advice_codition_time_type'] === 'মিনিট'){ echo 'selected';}?>>মিনিট</option>
													<option value="ঘন্টা" <?php if($obesitys['anti_obesity_advice_codition_time_type'] === 'ঘন্টা'){ echo 'selected';}?>>ঘন্টা</option>
												</select>
											</div>
											<div class="inline-sc" style="width: 25%;">
												<select name="crnt_obesity_condition_apply_<?php echo $med_count;?>" class="form-control" style="text-align: center;margin-top: -4px;font-size: 20px;">
													<option value="আগে" <?php if($obesitys['anti_obesity_advice_codition_apply'] === 'আগে'){ echo 'selected';}?> >আগে</option>
													<option value="পরে" <?php if($obesitys['anti_obesity_advice_codition_apply'] === 'পরে'){ echo 'selected';}?>>পরে</option>
												</select>
											</div>
										</div>
										<div class="col-sm-4 padding">
											<span style="display: block;width: 32%;float: left;font-size: 20px;">চলবে</span>
											<input type="text" value= "<?php echo $obesitys['anti_obesity_duration'];?>" name="crnt_obesity_duration_<?php echo $med_count;?>" style="float: left;width: 40%;font-size: 20px;margin-top: -4px;text-align: center;" class="">
											<div class="inline-sc" style="width: 22%;">
												<select name="crnt_obesity_duration_type_<?php echo $med_count;?>" class="form-control" style="text-align: center;margin-top: -4px;font-size: 20px;">
													<option value="দিন" <?php if($obesitys['anti_obesity_duration_type'] === 'দিন'){ echo 'selected';}?>>দিন</option>
													<option value="মাস" <?php if($obesitys['anti_obesity_duration_type'] === 'মাস'){ echo 'selected';}?>>মাস</option>
												</select>
											</div>
										</div>
										
										<input type="hidden" name="crnt_obesity_row[]" value="<?php echo $med_count;?>" />
										<div style="clear:both"></div>
									</div>
									<?php if($obesity_count === 1):?>
									<div style="padding-bottom: 10px" class="col-sm-3">
							...
							<div class = "col-sm-12 padding input-row-fields-5-cntr" style="display: none;" >
								<div style= ""  class = "col-sm-12 padding" >
								...
								foreach($other as $others):?>
									<div style = "box-shadow: 0px 0px 4px rgb(0 0 0 / 70%);"  class = "col-sm-12 padding p"  >
										...
										<div class="col-sm-12" style= "margin-top: 20px;height: 70px;">
											...
											<input type="text" value= "<?php echo $others['other_name'];?>" style = "height: 65px;font-size: 20px;" name="crnt_other_name_<?php echo $med_count;?>" placeholder="Add Others" class="load-drugs col-sm-10 padding p" />
										</div>
										<div class="col-sm-12" style = "height: 70px;">
											<label class="col-sm-2 padding p"> Dose: </label>
											<input type="text" value= "<?php echo $others['other_dose'];?>" style = "height: 65px;font-size: 20px;" name="crnt_other_value_<?php echo $med_count;?>" placeholder="ADD Dose" class="col-sm-10 padding p" />
										</div>
									...
									<div style= "padding-top: 20px;"  class = "col-sm-12 padding p" >
										<div class="col-sm-8 padding p">
											<div class="inline-sc" style="width: 40%;">
												<span style="display: block;width: 55%;float: left;font-size: 20px;">খাওয়ার</span> 
												<input type="text" value= "<?php echo $others['other_advice_codition_time'];?>" name="crnt_other_condition_time_<?php echo $med_count;?>" placeholder="" class="" style="float: left;width: 45%;font-size: 20px;margin-top: -4px;text-align: center;">
											</div>
											<div class="inline-sc" style="width: 25%;">
												<select name="crnt_other_condition_time_type_<?php echo $med_count;?>" class="form-control" style="text-align: center;margin-top: -4px;font-size: 20px;">
													<option value="মিনিট" <?php if($others['other_advice_codition_time_type'] === 'মিনিট'){ echo 'selected';}?>>মিনিট</option>
													<option value="ঘন্টা" <?php if($others['other_advice_codition_time_type'] === 'ঘন্টা'){ echo 'selected';}?>>ঘন্টা</option>
												</select>
											</div>
											<div class="inline-sc" style="width: 25%;">
												<select name="crnt_other_condition_apply_<?php echo $med_count;?>" class="form-control" style="text-align: center;margin-top: -4px;font-size: 20px;">
													<option value="আগে" <?php if($others['other_advice_codition_apply'] === 'আগে'){ echo 'selected';}?>>আগে</option>
													<option value="পরে" <?php if($others['other_advice_codition_apply'] === 'পরে'){ echo 'selected';}?>>পরে</option>
												</select>
											</div>
										</div>
										<div class="col-sm-4 padding">
											<span style="display: block;width: 32%;float: left;font-size: 20px;">চলবে</span>
											<input type="text" value= "<?php echo $others['other_duration'];?>" name="crnt_other_duration_<?php echo $med_count;?>" style="float: left;width: 40%;font-size: 20px;margin-top: -4px;text-align: center;" class="">
											<div class="inline-sc" style="width: 22%;">
												<select name="crnt_other_duration_type_<?php echo $med_count;?>" class="form-control" style="text-align: center;margin-top: -4px;font-size: 20px;">
													<option value="দিন" <?php if($others['other_duration_type'] === 'দিন'){ echo 'selected';}?>>দিন</option>
													<option value="মাস" <?php if($others['other_duration_type'] === 'মাস'){ echo 'selected';}?>>মাস</option>
												</select>
											</div>
										</div>
										
										<input type="hidden" name="crnt_other_row[]" value="<?php echo $med_count;?>" />
										<div style="clear:both"></div>
									</div>
									<?php if($other_count === 1):?>
									<div style="padding-bottom: 10px" class="col-sm-3">
			...
			$(document).on('change', '.sel-gexam-height', function(){
				...
				if(getValue == 'ft/inch')
				{
					var content = '<label class="">Height:</label>'+
									'<input  type="number" class="wif" name="gexam_height_value_ft" placeholder="ft"/>'+
									'<input  type="number" class="wif" name="gexam_height_value_inch" placeholder="inch"/>'+
									'<select name="gexam_height_unit" class=" sel-gexam-height wifi">'+
									'<option value="cm">cm</option>'+
					...
					var content = '<label class="">Height:</label>'+
					'<input  type="number" class="wih" name="gexam_height_value" placeholder="" />'+
					'<select name="gexam_height_unit" class=" sel-gexam-height wih">'+
	...
	$(document).ready(function(){
		...
		var row = <?php if($med_count > 1){ echo $med_count;} else{ echo 2;}?>;
			//load multiple oads
