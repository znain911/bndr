<?php require_once APPPATH.'modules/common/header.php' ?>
	...
	<div class="row bg-title">
		...
		<div class="col-lg-9 col-sm-12 col-md-12 col-xs-12">
			...
			<input type="submit" value="Scan QR Code" onclick="myFunction()" data-toggle="modal" data-target=".scan"  id = "" class = 'laptop qr-gn-scan'  style = '    background-color: #3c4451;color: white;'>
	...
	<div style = '' id = ''>
		...
		<form method="post" id = 'upload_image' enctype = "multipart/form-data">
			...
			<div class="container"  style = "    background-color: #f1f3f4;box-shadow: 0 -2px 7px rgb(5 29 103 / 70%);    margin-bottom: 10%;padding-bottom: 2%;">
				<div class="row">
				<?php if($this->session->userdata('user_type') !== 'Doctor'):
					...
					<div class="col-lg-6">
						<div class="form-group">
							<h4 class="control-label col-md-5" style = 'font-weight: bold;'>Name Of Doctor</h4>
							<div class="col-md-7">
								<input type="text" style = 'background-color: #f1f3f4;border: 0px;border-bottom: 1px solid #6b6464;' 
								class="form-control src-doctor-name-final-treatment" name="finaltreat_doctor_name" data-section="hidden-final-treatment-doctor" placeholder="Type name of doctor" />
					...
					<div class="col-lg-6">
						<div class="form-group">
							...
							<div class="col-md-7">
								<input type="date" style = 'background-color: #f1f3f4;border: 0px;border-bottom: 1px solid #6b6464;'  name="finaltreat_date" value="<?php echo date("Y-m-d"); ?>" placeholder="DD/MM/YYYY" class="form-control text-center ">
							</div>
						</div>
					</div>
					<div class="col-sm-12">
						<h3 class="" style = 'font-weight: bold;    display: inline-block;'>Progress Report <span style="color:#f00; ">*</span></h3>
						<a onclick="return theFunction();" style="padding: 6px 10px;margin-left: 2%;" class="add-vst-button ">Add More Image</a>
					</div>
					<div class="col-sm-12 imageContainer">
						<input class="col-sm-7 imageInput" type="file" accept=".jpg,.jpeg" capture="camera" style="    " name="image1" id= "image_file1" />
						<input  type="hidden"  name="image_array[]" value = '1' />
					...
					<div class="col-sm-12">
						<div class="col-sm-6">
							<input type="submit" style="padding: 3%;font-weight: bold;margin-top: 2%;  background-color: #2980c6;color: white;" name="upload" id= "upload" value = "Upload"/>
						</div>
					</div>
			...
			$(".qr-gn").click(function(){
			 //alert('hello');
				...
				$.ajax({
				  ...
				  //document.location.href = baseUrl+'patients/progress/image_progress/'+<?php echo $patient_id;?>+'/'+bndrId;
			});
	...
	<script type="text/javascript">
	 ...
	 function theFunction () {
	   ...
	   var row = $('.imageInput').length+1;
	   //alert(row);
	   var content = '<input class="col-sm-7 imageInput" type="file" accept=".jpg,.jpeg" style = "margin-top: 2%" capture="camera" name="image'+row+'" id= "image_file1" />'+
					'<input  type="hidden"  name="image_array[]" value = "'+row+'" />';
		$('.imageContainer').append(content);
		if(row === 8){
			//alert('Only 5 intake is allowed');
			$('.add-vst-button ').hide();
		}
    }
	$(document).ready(function(){
		$('#upload_image').on('submit', function(e){  
		   ...
		   {  
				$('#visitLoader').show();
				$.ajax({  
					 url: baseUrl + "patients/progress/image/" + pid,   
					 method:"POST",  
