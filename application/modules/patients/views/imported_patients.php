<?php require_once APPPATH.'modules/common/header.php' ?>
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="add-href-unit">
				<strong style="margin-top:15px;" class="pull-left">IMPORTED PATIENTS</strong>
				...
				<a href="<?php echo base_url('patients/export/excel?type=IMPORTED'); ?>" class="add-vst-button pull-right" style="margin-right:15px;"><i class="fa fa-plus-square"></i> EXPORT EXCEL</a>
				<a href="<?php echo base_url('patients/export/csv?type=IMPORTED'); ?>" class="add-vst-button pull-right" style="margin-right:15px;"><i class="fa fa-plus-square"></i> EXPORT CSV</a>
			</div>
	...
	<script type="text/javascript">
		function searchFilter(page_num) {
			...
			$.ajax({
				type: 'POST',
				url: '<?php echo base_url(); ?>pfilter/get_all_imported_patients/'+page_num,
