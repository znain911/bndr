...
class Division extends CI_Controller {
	...
	public function __construct()
	{
	  ...
	  $this->load->model('setup/Division_model', 'Division_model', true);
	...
	public function save()
	{
		...
		$data = array(
					'division_name'        => html_escape($this->input->post('title')),
					'division_created_by'  => $this->active_user,
					'division_create_date' => date("Y-m-d H:i:s"),
				);
		$validate = array(
						array(
							'field' => 'title', 
		...
		{
			//save
			$this->Division_model->create($data);
	...
	public function delete()
	{
		...
		$this->db->delete('starter_divisions');
