...
class Physical extends CI_Controller {
	...
	public function __construct()
	{
	  ...
	  $this->load->model('setup/Physical_model', 'Physical_model', true);
	...
	public function save()
	{
		...
		$data = array(
					'activity_title'       => html_escape($this->input->post('title')),
					'activity_created_by'  => $this->active_user,
		...
		{
			//save
			$this->Physical_model->create($data);
	...
	public function delete()
	{
		...
		$this->db->delete('starter_physical_activities');
