...
class Company extends CI_Controller {
	...
	public function __construct()
	{
	  ...
	  $this->load->model('setup/Company_model', 'Company_model', true);
	...
	public function save()
	{
		...
		$data = array(
					'company_title'       => html_escape($this->input->post('title')),
					'company_created_by'  => $this->active_user,
	...
	public function delete()
	{
		...
		$this->db->delete('starter_dgds_companies');
