...
class Visit_model extends CI_Model {
	...
	public function get_visit_id($entry_id)
	{
		$query = $this->db->query("SELECT visit_id FROM starter_patient_visit WHERE visit_entryid='$entry_id' LIMIT 1");
		$result = $query->row_array();
		return $result['visit_id'];
	}
	
	public function update_sync($visit_entryid, $data)
	{
		$this->db->where('visit_entryid', $visit_entryid);
		$this->db->update('starter_patient_visit', $data);
	}
	
	public function save_visit_general_examination($data)
	{
		$this->db->insert('starter_visit_general_examinations', $data);
	}
	...
	{
		$this->db->insert('starter_visit_laboratory_investigations', $data);
	}
	...
	public function get_all_visits($params=array())
	{
		...
		$query = "SELECT starter_patient_visit.*, starter_visit_payments.*, starter_visit_diabetes_histories.dhistory_duration_of_glucose FROM starter_patient_visit
	...
	{
		$query = $this->db->query("SELECT visit_id, visit_form_version FROM starter_patient_visit WHERE starter_patient_visit.visit_id='$visit_id' AND starter_patient_visit.visit_patient_id='$patient_id' AND starter_patient_visit.visit_entryid='$visit_entryid' LIMIT 1");
		return $query->row_array();
	}
	...
	public function get_drug_info($term)
	{
		$query = $this->db->query("SELECT 
								   ...
								   starter_pharmaceuticals.company 
								   FROM starter_dgds
								   LEFT JOIN starter_pharmaceuticals ON
								   starter_pharmaceuticals.pharmaID=starter_dgds.company
	...
	{
		$query = $this->db->query("SELECT * FROM starter_pharmaceuticals WHERE starter_pharmaceuticals.pharmaID='$company_id' LIMIT 1");
		return $query->row_array();
	}
	...
	{
		$query = $this->db->query("SELECT * FROM starter_visit_general_examinations
	...
	{
		$query = $this->db->query("SELECT inv_id, inv_name FROM starter_lab_investigations");
		return $query->result_array();
	}
	
	public function get_patient_id($entryid)
	{
		$query = $this->db->query("SELECT patient_id FROM starter_patients WHERE patient_entryid='$entryid' LIMIT 1");
		$result = $query->row_array();
