...
class Drugs_model extends CI_Model {
	...
	public function get_all_items()
	{
		$query = $this->db->query("SELECT * FROM starter_dgds 
								   ...
								   LEFT JOIN starter_dgds_companies ON
								   starter_dgds_companies.company_id=starter_dgds.company
	...
	{
		$query = $this->db->query("SELECT company_id, company_title FROM starter_dgds_companies ORDER BY company_id ASC");
		return $query->result_array();
	}
